...
will be automatically restarted after installing this update."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2011-October/018117.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?21cbe44c"
  );
  # http://lists.centos.org/pipermail/centos-announce/2011-October/018118.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb4979a6"
  );
  script_set_attribute(
    attribute:"solution", 
