...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-2843.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-45.5.1-1.el5_11")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-45.5.1-1.el5_11")) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-45.5.1-1.el6_8")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-45.5.1-1.el6_8")) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-45.5.1-1.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"firefox-45.5.1-1.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"firefox-45.5.1-1.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-45.5.1-1.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"firefox-debuginfo-45.5.1-1.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"firefox-debuginfo-45.5.1-1.el7_3")) flag++;
