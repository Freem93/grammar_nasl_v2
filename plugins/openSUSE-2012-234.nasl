...
if (description)
{
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-04/msg00046.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"libtiff-devel-3.9.4-3.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libtiff3-3.9.4-3.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libtiff3-debuginfo-3.9.4-3.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"tiff-3.9.4-3.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"tiff-debuginfo-3.9.4-3.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"tiff-debugsource-3.9.4-3.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libtiff-devel-32bit-3.9.4-3.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libtiff3-32bit-3.9.4-3.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libtiff3-debuginfo-32bit-3.9.4-3.25.1") ) flag++;
