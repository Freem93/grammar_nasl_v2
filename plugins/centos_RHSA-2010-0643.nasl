...
this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c5a1439f"
  );
  # http://lists.centos.org/pipermail/centos-announce/2010-August/016937.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7913d261"
  );
  # http://lists.centos.org/pipermail/centos-announce/2010-August/016938.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f17c6b2"
  );
  # http://lists.centos.org/pipermail/centos-announce/2010-August/016939.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?acc52d0c"
  );
  script_set_attribute(
    attribute:"solution", 
