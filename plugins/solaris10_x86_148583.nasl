...
if (description)
{
  ...
  script_cvs_date("$Date: 2016/10/18 17:03:09 $");

  script_name(english:"Solaris 10 (x86) : 148583-08");
  script_summary(english:"Check for patch 148583-08");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 148583-08"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"148583-08", obsoleted_by:"", package:"SUNWiimdv", version:"9.0,REV=2011.09.05") < 0) flag++;
