...
Adobe Flash ActiveX control, which could lead to code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"http://support.microsoft.com/kb/2898108");
  script_set_attribute(attribute:"solution", value:"Install Microsoft KB2898108.");
