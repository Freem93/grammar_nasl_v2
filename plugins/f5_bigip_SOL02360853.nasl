...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"CVE-2015-5194 - reserved Crash with crafted logconfig configuration
command.

CVE-2015-5195 - reserved Crash when processing config commands with
statistics type."
  );
  script_set_attribute(
    attribute:"see_also",
