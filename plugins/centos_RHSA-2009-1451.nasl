...
installing the update, radiusd will be restarted automatically."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2009-October/016228.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76397f34"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-October/016229.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c9242f54"
  );
  script_set_attribute(
    attribute:"solution", 
