...
if (description)
{
  ...
  script_osvdb_id(104196, 104197, 104198, 104199);
...
execution.  (CVE-2014-2299)");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.wireshark.org/security/wnpa-sec-2014-02.html");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.wireshark.org/lists/wireshark-announce/201403/msg00000.html");
  script_set_attribute(attribute:"solution", value:"Upgrade to Wireshark version 1.10.6 or later.");
...
foreach install(keys(installs))
{
  ...
  if (version =~ "^1\.10\.[0-5]($|[^0-9])")
    info +=
      '\n  Path              : ' + installs[install] +
      '\n  Installed version : ' + version +
      '\n  Fixed version     : 1.10.6\n';
  else
