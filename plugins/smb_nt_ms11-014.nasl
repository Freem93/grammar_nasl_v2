...
if (description)
{
  ...
  script_osvdb_id(70885);
  script_xref(name:"IAVA", value:"2011-A-0024");
...
leverage this issue to gain full administrative rights."
  ...
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms11-014");
