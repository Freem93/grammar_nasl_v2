...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/06/03 19:53:45 $");
...
bugs."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1306&L=scientific-linux-errata&T=0&P=75
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?16e715b7"
  );
