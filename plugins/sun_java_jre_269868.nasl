...
if (description)
{
  ...
  script_cve_id("CVE-2009-3728", "CVE-2009-3729", "CVE-2009-3864", 
...
security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://download.oracle.com/sunalerts/1021046.1.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://download.oracle.com/sunalerts/1021046.1.html"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://download.oracle.com/sunalerts/1021048.1.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://download.oracle.com/sunalerts/1021048.1.html"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://download.oracle.com/sunalerts/1021083.1.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://download.oracle.com/sunalerts/1021084.1.html"
  );
  script_set_attribute(
    attribute:"solution",
    value:
