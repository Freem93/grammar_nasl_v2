...
if (description)
{
  ...
  script_osvdb_id(143387, 143388, 150415, 150416, 150417, 150419, 150420, 150421, 150422, 150423, 150425, 150426, 150427, 150428, 150429);
...
CVE-2017-3289)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-0336.html"
  );
