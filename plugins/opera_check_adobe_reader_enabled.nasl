...
if (description)
{
  ...
  script_set_attribute(attribute:"synopsis", value:"The remote host has Adobe Reader enabled for Opera.");
  script_set_attribute(attribute:"description", value:"Adobe Reader is enabled in Opera.");
