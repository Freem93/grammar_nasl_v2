...
contain a backported patch and is not vulnerable to this issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-January/013460.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fe94e75a"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-January/013461.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f799b57"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-January/013464.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?876b5012"
  );
  script_set_attribute(
    attribute:"solution", 
