...
service could be restored by rebooting the server.");
 script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms01-048");
 ...
 script_copyright(english:"This script is Copyright (C) 2001-2017 Michael Scheidell");
