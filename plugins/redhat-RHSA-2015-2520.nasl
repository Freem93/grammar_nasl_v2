...
update, the ntpd daemon will restart automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-2520.html"
  );
...
os_ver = os_ver[1];
if (! ereg(pattern:"^(6\.5|6\.6)([^0-9]|$)", string:os_ver)) audit(AUDIT_OS_NOT, "Red Hat 6.5 / 6.6", "Red Hat " + os_ver);
...
{  sp = get_kb_item("Host/RedHat/minor_release");
  ...
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"s390x", reference:"ntp-4.2.6p5-2.el6_5.1")) flag++;
  ...
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"i686", reference:"ntp-perl-4.2.6p5-2.el6_5.1")) flag++;
  ...
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"s390x", reference:"ntpdate-4.2.6p5-2.el6_5.1")) flag++;
