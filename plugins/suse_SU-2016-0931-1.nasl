...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/959094"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/960305"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/961173"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-5313.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160931-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?05831f2f"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
