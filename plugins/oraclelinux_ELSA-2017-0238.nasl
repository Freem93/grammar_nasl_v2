...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-45.7.0-1.0.1.el6_8")) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"thunderbird-45.7.0-1.0.1.el7_3")) flag++;
