...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.7.0-openjdk on SL5.x i386/x86_64 (POODLE)");
...
to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1501&L=scientific-linux-errata&T=0&P=1639
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8015f858"
  );
