...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : samba on SL4.x i386/x86_64");
...
this update, the smb service will be restarted automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1202&L=scientific-linux-errata&T=0&P=3913
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?016c8213"
  );
