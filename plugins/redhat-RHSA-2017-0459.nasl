...
Chen, and Nathan Froyd as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-0459.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-45.8.0-2.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-45.8.0-2.el5_11")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-45.8.0-2.el6_8")) flag++;
  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-45.8.0-2.el6_8")) flag++;
