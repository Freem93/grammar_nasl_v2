...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/947271"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/957568"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-8313.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160077-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e1531bb3"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
