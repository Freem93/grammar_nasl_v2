...
updated packages, which add this enhancement."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-2659.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"httpd24-2.4.6-59.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"httpd24-2.4.6-59.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"httpd24-debuginfo-2.4.6-59.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"httpd24-debuginfo-2.4.6-59.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"httpd24-devel-2.4.6-59.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"httpd24-devel-2.4.6-59.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"httpd24-manual-2.4.6-59.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"httpd24-tools-2.4.6-59.ep7.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"httpd24-tools-2.4.6-59.ep7.el6")) flag++;
