...
if (description)
{
  ...
  script_osvdb_id(40905, 128634, 128635, 134458, 134459);
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160677-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3a39508a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
