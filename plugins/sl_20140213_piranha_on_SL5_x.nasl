...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : piranha on SL5.x i386/x86_64");
...
administrative credentials. (CVE-2013-6492)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1402&L=scientific-linux-errata&T=0&P=1690
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?124fda35"
  );
  script_set_attribute(
    attribute:"solution", 
