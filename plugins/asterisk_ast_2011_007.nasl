...
cause Asterisk to crash.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://seclists.org/bugtraq/2011/Jun/27");

  script_set_attribute(attribute:"solution", value:"Upgrade to Asterisk 1.8.4.2 or later.");
