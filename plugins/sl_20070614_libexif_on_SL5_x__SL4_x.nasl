...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/04/01 10:47:03 $");
...
arbitrary code or crash. (CVE-2007-4168)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind0706&L=scientific-linux-errata&T=0&P=1882
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?af2bb9f5"
  );
  script_set_attribute(
    attribute:"solution", 
