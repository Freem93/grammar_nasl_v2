...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 139397-02");
  script_summary(english:"Check for patch 139397-02");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 139397-02"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"139397-02", obsoleted_by:"", package:"SUNWldm", version:"1.0.2,REV=2008.02.11.14.26") < 0) flag++;
