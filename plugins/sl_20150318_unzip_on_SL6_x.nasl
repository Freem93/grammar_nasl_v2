...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : unzip on SL6.x, SL7.x i386/x86_64");
...
when the archive was uncompressed. (CVE-2014-8141)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1503&L=scientific-linux-errata&T=0&P=1514
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4a83adda"
  );
  script_set_attribute(
    attribute:"solution", 
