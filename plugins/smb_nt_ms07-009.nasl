...
if (description)
{
 ...
 script_osvdb_id(31882);
 script_xref(name:"MSFT", value:"MS07-009");
 script_xref(name:"IAVA", value:"2007-A-0015");
...
malicious web page and entice a victim to visit this web page.");
 script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS07-009");
