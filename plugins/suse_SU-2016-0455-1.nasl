...
if (description)
{
  ...
  script_osvdb_id(134093, 134094, 134095);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/964845"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/964847"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/964849"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-8803.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-8804.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-8805.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160455-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d89aff55"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
