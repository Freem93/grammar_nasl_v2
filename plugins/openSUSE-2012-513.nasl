...
if (description)
{
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-08/msg00022.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"icedtea-web-1.2.1-0.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"icedtea-web-debuginfo-1.2.1-0.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"icedtea-web-debugsource-1.2.1-0.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"icedtea-web-javadoc-1.2.1-0.17.1") ) flag++;
