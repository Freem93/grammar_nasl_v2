...
must be restarted for the update to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2009-March/015678.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?51d805e1"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015898.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015899.html"
  );
  script_set_attribute(
    attribute:"solution", 
