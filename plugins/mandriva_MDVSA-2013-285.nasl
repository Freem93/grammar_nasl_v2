...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/11/27 15:51:16 $");
...
not affected by these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.bugzilla.org/releases/4.2.6/release-notes.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.bugzilla.org/releases/4.2.7/release-notes.html"
  );
  script_set_attribute(
    attribute:"solution", 
