...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python-jinja2 on SL6.x i386/x86_64");
...
must be restarted."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1406&L=scientific-linux-errata&T=0&P=1980
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?58006e67"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
