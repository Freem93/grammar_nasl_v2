...
if (description)
{
  ...
  script_osvdb_id(84980, 84981, 86344, 86345, 86348, 86349, 86351, 86354, 86355, 86357, 86358, 86361, 86362, 86365, 86366, 86367, 86368, 86369, 86371, 87300, 87301, 87302);
...
instances of IBM Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2012-1466.html"
  );
