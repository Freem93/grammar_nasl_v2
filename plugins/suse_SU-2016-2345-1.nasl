...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/994157"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-6313.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162345-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?afa6801a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
