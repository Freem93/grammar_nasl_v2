...
these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2003-0989.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2004-0055.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2004-0057.html"
  );
  # http://marc.theaimsgroup.com/?l=tcpdump-workers&m=107325073018070
  script_set_attribute(
    attribute:"see_also",
    value:"http://marc.info/?l=tcpdump-workers&m=107325073018070"
  );
  script_set_attribute(
    attribute:"see_also",
