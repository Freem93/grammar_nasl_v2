...
# extracted from F5 Networks BIG-IP Solution SOL17113.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSH vulnerability (SOL17113)");
...
element on this list."
  ...
  # http://support.f5.com/kb/en-us/solutions/public/17000/100/sol17113.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?67c3be1e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
