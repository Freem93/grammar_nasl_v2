...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"02", patch:"IV86119s0a", package:"bos.net.tcp.imapd", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"02", patch:"IV86119s0a", package:"bos.net.tcp.pop3d", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"02", patch:"IV86119s0a", package:"bos.net.tcp.sendmail", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.0") < 0) flag++;
