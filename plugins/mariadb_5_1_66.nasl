...
arbitrary code.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://kb.askmonty.org/en/mariadb-5166-release-notes/");
  script_set_attribute(attribute:"solution", value:"Upgrade to MariaDB version 5.1.66 or later.");
...
mysql_check_version(variant:'MariaDB', fixed:'5.1.66-MariaDB', min:'5.1', severity:SECURITY_WARNING);
