...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : axis on SL6.x (noarch)");
...
take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1302&L=scientific-linux-errata&T=0&P=2954
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f7855a91"
  );
  script_set_attribute(
    attribute:"solution", 
