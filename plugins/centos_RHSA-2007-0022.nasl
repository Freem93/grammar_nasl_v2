...
manually is recommended."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-February/013500.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?625fa633"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-February/013501.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?18389d37"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-February/013502.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ec531300"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-January/013487.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aee8c407"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-January/013488.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9727d090"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2007/02/03");
