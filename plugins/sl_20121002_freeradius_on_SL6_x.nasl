...
if (description)
{
  ...
  script_cvs_date("$Date: 2012/10/04 10:55:03 $");
...
installing the update, radiusd will be restarted automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1210&L=scientific-linux-errata&T=0&P=840
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?58526582"
  );
