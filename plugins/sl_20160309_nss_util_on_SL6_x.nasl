...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss-util on SL6.x, SL7.x i386/x86_64");
...
nss- util library must be restarted, or the system rebooted."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1603&L=scientific-linux-errata&F=&S=&P=3846
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?721f04ed"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
