...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/09/msg00004.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/jsch"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected libjsch-java, and libjsch-java-doc packages."
  );
