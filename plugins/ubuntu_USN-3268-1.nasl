...
if (description)
{
  ...
  script_osvdb_id(145695, 148268, 148376, 148377, 149126, 150501, 150693, 150793, 152081, 153023, 153753);
...
if (! ereg(pattern:"^(17\.04)$", string:release)) audit(AUDIT_OS_NOT, "Ubuntu 17.04", "Ubuntu " + release);
