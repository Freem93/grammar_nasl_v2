...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2016-B-0016");
...
memory, resulting in an elevation of privileges.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://kb.vmware.com/kb/2135123");
  script_set_attribute(attribute:"see_also", value:"http://kb.vmware.com/kb/2135114");
