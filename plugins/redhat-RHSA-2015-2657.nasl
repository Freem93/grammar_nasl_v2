...
if (description)
{
  ...
  script_osvdb_id(125392, 131857, 131858, 131860, 131863, 131864, 131866, 131868, 131870);
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2015-7210.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2015-7222.html"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-2657.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-38.5.0-2.el5_11")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-38.5.0-2.el5_11")) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-38.5.0-2.el6_7")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-38.5.0-2.el6_7")) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-38.5.0-3.el7_2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-38.5.0-3.el7_2")) flag++;
