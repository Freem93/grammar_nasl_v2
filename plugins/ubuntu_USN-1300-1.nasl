...
# Notice USN-1300-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2011-4077", "CVE-2011-4132", "CVE-2011-4330");
  ...
  script_name(english:"USN-1300-1 : linux-fsl-imx51 vulnerabilities");
...
could crash the system or gain root privileges. (CVE-2011-4330)");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1300-1/");
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.31-612-imx51", pkgver:"2.6.31-612.31")) flag++;
