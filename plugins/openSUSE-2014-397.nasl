...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2014-397 patch");
...
"  - fix CVE-2014-0130: rubygem-actionpack: directory
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2014-05/msg00078.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=876714"
  );
  script_set_attribute(
    attribute:"solution", 
