...
if (description)
{
  ...
  script_osvdb_id(102068, 102069, 102075);
...
following components :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to MySQL 5.1.72 or later.");
...
mysql_check_version(fixed:'5.1.72', min:'5.1', severity:SECURITY_WARNING);
