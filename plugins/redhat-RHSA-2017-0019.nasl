...
Note: This update removes the vulnerable FLC/FLI/FLX plug-in."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-0019.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"gstreamer-plugins-good-0.10.31-12.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"gstreamer-plugins-good-0.10.31-12.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"gstreamer-plugins-good-debuginfo-0.10.31-12.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"gstreamer-plugins-good-debuginfo-0.10.31-12.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"gstreamer-plugins-good-debuginfo-0.10.31-12.el7_3")) flag++;
