...
changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2013-August/019895.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f06bef35"
  );
  # http://lists.centos.org/pipermail/centos-announce/2013-August/019898.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b64b8ac3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-17.0.8-5.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-17.0.8-5.el6.centos")) flag++;
