...
relied only on the application's self-reported version number.");
  # https://confluence.atlassian.com/display/DOC/Confluence+Security+Advisory+2011-01-18
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92649952");
