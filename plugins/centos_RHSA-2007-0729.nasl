...
which contain a backported patch to resolve this issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-August/014119.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22391bef"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-August/014120.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ad92798"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-July/014095.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c194c797"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-July/014108.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8d4ab092"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-July/014109.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f59a3f3"
  );
  script_set_attribute(
    attribute:"solution", 
