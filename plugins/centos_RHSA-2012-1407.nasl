...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?912151a8"
  );
  # http://lists.centos.org/pipermail/centos-announce/2012-October/018959.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?38b31ae9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-10.0.10-1.el5.centos")) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-10.0.10-1.el5_8")) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-devel-10.0.10-1.el5_8")) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-10.0.10-1.el6.centos")) flag++;
if (rpm_check(release:"CentOS-6", reference:"xulrunner-10.0.10-1.el6.centos")) flag++;
if (rpm_check(release:"CentOS-6", reference:"xulrunner-devel-10.0.10-1.el6.centos")) flag++;
