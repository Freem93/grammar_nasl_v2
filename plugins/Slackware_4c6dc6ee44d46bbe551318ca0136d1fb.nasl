...
if (description)
{
  ...
  script_name(english:"Slackware 8.1 / current : New CVS packages available");
  ...
  script_set_attribute(
    ...
    value:"New cvs packages are available to fix a security vulnerability."
  );
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2003&m=slackware-security.213783
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7fcedd19"
  );
...
flag = 0;
if (slackware_check(osver:"8.1", pkgname:"cvs", pkgver:"1.11.5", pkgarch:"i386", pkgnum:"1")) flag++;

if (slackware_check(osver:"current", pkgname:"cvs", pkgver:"1.11.5", pkgarch:"i386", pkgnum:"1")) flag++;
