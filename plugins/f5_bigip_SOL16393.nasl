...
# extracted from F5 Networks BIG-IP Solution SOL16393.
#
...
if (description)
{
  ...
  script_osvdb_id(116072);

  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (SOL16393)");
...
packets by spoofing ::1 addresses from the outside."
  );
  # http://support.f5.com/kb/en-us/solutions/public/16000/300/sol16393.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?87e9259b"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
