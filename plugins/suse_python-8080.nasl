...
if (description)
{
  ...
  script_cve_id("CVE-2011-1015", "CVE-2011-3389");

  script_name(english:"SuSE 10 Security Update : Python (ZYPP Patch Number 8080)");
...
can inject values into your hash tables."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8080.");
