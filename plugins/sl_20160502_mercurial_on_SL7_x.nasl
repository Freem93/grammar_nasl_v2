...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mercurial on SL7.x x86_64");
...
"Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1605&L=scientific-linux-errata&F=&S=&P=74
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?92b452c6"
  );
