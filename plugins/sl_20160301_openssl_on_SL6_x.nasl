...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssl on SL6.x, SL7.x i386/x86_64 (DROWN)");
...
library must be restarted, or the system rebooted."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1603&L=scientific-linux-errata&F=&S=&P=675
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c52e6e8e"
  );
