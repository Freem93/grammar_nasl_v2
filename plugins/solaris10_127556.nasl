...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 127556-05");
  script_summary(english:"Check for patch 127556-05");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 127556-05"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"127556-05", obsoleted_by:"", package:"SUNWuttsc", version:"2.0_23") < 0) flag++;
