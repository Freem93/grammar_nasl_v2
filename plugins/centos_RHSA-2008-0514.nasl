...
contain backported patches which resolves these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-June/015032.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dfedec82"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-June/015033.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e6a41def"
  );
  script_set_attribute(
    attribute:"solution", 
