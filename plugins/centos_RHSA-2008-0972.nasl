...
packages, which contain backported patches to correct these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-November/015424.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c7ae6aa1"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-November/015425.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8e819a06"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-November/015443.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?96709130"
  );
  script_set_attribute(
    attribute:"solution", 
