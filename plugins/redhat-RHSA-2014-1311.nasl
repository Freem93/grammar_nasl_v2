...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : bash (RHSA-2014:1311)");
...
contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2014-1311.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{  sp = get_kb_item("Host/RedHat/minor_release");
  ...
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"bash-4.1.2-15.el6_4.2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"bash-4.1.2-9.el6_2.2")) flag++;
  ...
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"bash-debuginfo-4.1.2-15.el6_4.2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"bash-debuginfo-4.1.2-9.el6_2.2")) flag++;
