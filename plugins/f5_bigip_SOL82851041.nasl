...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"Undisclosed traffic patterns received while software SYN cookie
protection is engaged may cause a disruption of service to the Traffic
Management Microkernel (TMM) on specific platforms and configurations.
(CVE-2017-6137)"
  );
  script_set_attribute(
    attribute:"see_also",
