...
"https://getupdates.oracle.com/readme/149192-01");
 ...
 script_set_attribute(attribute: "plugin_type", value: "local");
  ...
  script_cvs_date("$Date: 2012/11/28 12:15:17 $");
...
e +=  solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"149192-01", obsoleted_by:"147441-26 ", package:"SUNWnfssu", version:"11.10.0,REV=2005.01.21.16.34");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
