...
if (description)
{
  ...
  script_osvdb_id(122978, 123158, 125127, 126934);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/912889"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/933922"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/935119"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/939246"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/943816"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/950114"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-3218.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-3255.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-3256.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-4625.html"
  );
