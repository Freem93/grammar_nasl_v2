...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 119009-11");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119009-11", obsoleted_by:"", package:"VRTSnetbp", version:"6.0,REV=2005.09.07.19.13") < 0) flag++;
