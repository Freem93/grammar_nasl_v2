...
execute code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-09/msg00076.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-2.1.10-8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-debuginfo-2.1.10-8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-debugsource-2.1.10-8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-devel-2.1.10-8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-dialupadmin-2.1.10-8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-libs-2.1.10-8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-libs-debuginfo-2.1.10-8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-utils-2.1.10-8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"freeradius-server-utils-debuginfo-2.1.10-8.1") ) flag++;
