...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : gstreamer-plugins-good on SL7.x x86_64");
...
Note: This update removes the vulnerable FLC/FLI/FLX plug-in."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1701&L=scientific-linux-errata&F=&S=&P=2427
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b6a00eb"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
