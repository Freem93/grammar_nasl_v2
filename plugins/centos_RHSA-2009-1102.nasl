...
instances of cscope must be restarted for this update to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2009-June/015989.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f28c0652"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-June/015990.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cb4c718a"
  );
  script_set_attribute(
    attribute:"solution", 
