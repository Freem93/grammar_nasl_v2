...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libuser on SL6.x i386/x86_64");
...
(CVE-2015-3245, CVE-2015-3246)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1508&L=scientific-linux-errata&F=&S=&P=403
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c413a37e"
  );
