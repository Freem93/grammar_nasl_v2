...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : gimp
gimp-help (EulerOS-SA-2016-1075)");
...
without introducing additional issues.");
  # http://developer.huawei.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1075
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2d8f4ad2");
  script_set_attribute(attribute:"solution", value:
"Update the affected gimp
gimp-help package.");
