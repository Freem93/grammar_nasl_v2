...
if (description)
{
  ...
  script_osvdb_id(125256, 144952, 144999, 145250);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1001951"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/939342"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-5653.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-3228.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-7977.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-7979.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162493-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ff18588"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
