...
if (description)
{
  ...
  script_cvs_date("$Date: 2014/12/04 20:22:31 $");
...
delete arbitrary files without authorization.");
  script_set_attribute(attribute:"see_also", value:"http://seclists.org/bugtraq/2014/Dec/att-14/ESA-2014-156.txt");
  script_set_attribute(attribute:"solution", value:"Apply the relevant patch referenced in the vendor advisory.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:C/I:P/A:C");
