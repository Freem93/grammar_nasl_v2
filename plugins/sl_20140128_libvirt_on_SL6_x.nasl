...
if (description)
{
  ...
  script_cvs_date("$Date: 2014/02/26 11:41:41 $");
...
automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1401&L=scientific-linux-errata&T=0&P=1355
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b47cf39"
  );
