...
will be provided. (CVE-2015-5180)"
  );
  script_set_attribute(
    attribute:"see_also",
...
vmatrix["APM"]["unaffected"] = make_list("11.4.0-11.6.1","11.2.1");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("13.0.0","12.0.0-12.1.2");
vmatrix["ASM"]["unaffected"] = make_list("11.4.0-11.6.1","11.2.1");
...
vmatrix["LC"]["unaffected"] = make_list("11.4.0-11.6.1","11.2.1");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("13.0.0","12.0.0-12.1.2");
vmatrix["LTM"]["unaffected"] = make_list("11.4.0-11.6.1","11.2.1");
