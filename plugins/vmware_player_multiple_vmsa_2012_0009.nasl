...
if (description)
{
  ...
  script_cve_id("CVE-2012-1516", "CVE-2012-1517", "CVE-2012-2449", "CVE-2012-2450");
...
affected by the following vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to VMware Player 3.1.6 / 4.0.3 or later.");
