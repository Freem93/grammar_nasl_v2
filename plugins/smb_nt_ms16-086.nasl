...
if (description)
{
  ...
  script_cvs_date("$Date: 2016/07/21 14:07:54 $");

  script_cve_id("CVE-2016-3204");
  script_bugtraq_id(91584);
  script_osvdb_id(141383);
...
context of the current user.");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms16-086");
