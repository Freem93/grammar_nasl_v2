...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 123040-01");
  script_summary(english:"Check for patch 123040-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 123040-01"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10_x86", arch:"x64", patch:"123040-01", obsoleted_by:"124522-01 ", package:"SUNWsgeeax", version:"6.0u4,REV=2005.05.06.11.30") < 0) flag++;
