...
these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2005-June/011815.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?72649e8b"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-June/011816.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4c67f229"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-June/011839.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?916ed5c2"
  );
  script_set_attribute(
    attribute:"solution", 
