...
if (description)
{
  ...
  script_osvdb_id(74402);
  script_xref(name:"MSFT", value:"MS11-062");
  script_xref(name:"IAVA", value:"2011-A-0117");
...
elevated privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms11-062");
