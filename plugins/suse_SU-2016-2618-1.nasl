...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1005258"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-1245.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162618-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dd9a5f36"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
