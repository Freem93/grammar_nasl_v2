...
reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-6313.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-2674.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"libgcrypt-1.5.3-13.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"libgcrypt-1.5.3-13.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libgcrypt-debuginfo-1.5.3-13.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"libgcrypt-debuginfo-1.5.3-13.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"libgcrypt-debuginfo-1.5.3-13.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libgcrypt-devel-1.5.3-13.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"libgcrypt-devel-1.5.3-13.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"libgcrypt-devel-1.5.3-13.el7_3.1")) flag++;
