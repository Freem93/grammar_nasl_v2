...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 125279-05"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"125279-05", obsoleted_by:"", package:"SUNWdtwm", version:"1.6,REV=10.2004.12.17") < 0) flag++;
