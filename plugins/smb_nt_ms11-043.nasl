...
if (description)
{
  ...
  script_osvdb_id(72960);
  script_xref(name:"MSFT", value:"MS11-043");
  script_xref(name:"IAVA", value:"2011-A-0079");
...
attacker could exploit this to execute arbitrary code."
  ...
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms11-043");
  script_set_attribute(
    attribute:"solution",
    value:
