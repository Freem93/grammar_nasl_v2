...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libjpeg-turbo on SL6.x i386/x86_64");
...
CVE-2013-6630)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=3457
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4d60860a"
  );
