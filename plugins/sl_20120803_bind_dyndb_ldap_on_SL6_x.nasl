...
if (description)
{
  ...
  script_cvs_date("$Date: 2012/08/09 10:44:19 $");
...
update to take effect, the named service must be restarted."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1208&L=scientific-linux-errata&T=0&P=733
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ac368443"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
