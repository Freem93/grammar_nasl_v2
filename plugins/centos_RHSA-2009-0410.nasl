...
effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2009-April/015726.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?379e7ef1"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-April/015730.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f01fdbdd"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-April/015731.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eb2a4403"
  );
