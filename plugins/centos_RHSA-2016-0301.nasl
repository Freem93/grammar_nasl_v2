...
be restarted, or the system rebooted."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2016-March/021712.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?088c87ee"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-March/021713.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?39d41425"
  );
  script_set_attribute(
    attribute:"solution", 
