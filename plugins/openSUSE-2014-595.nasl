...
if (description)
{
  ...
  script_cve_id("CVE-2014-6271", "CVE-2014-6277", "CVE-2014-6278", "CVE-2014-7169", "CVE-2014-7187");
  script_xref(name:"IAVA", value:"2014-A-0142");

  script_name(english:"openSUSE Security Update : bash (openSUSE-SU-2014:1310-1) (Shellshock)");
  script_summary(english:"Check for the openSUSE-2014-595 patch");
...
"  - Replace patches bash-4.2-heredoc-eof-delim.patch and
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2014-10/msg00025.html"
  );
  script_set_attribute(
    attribute:"see_also",
