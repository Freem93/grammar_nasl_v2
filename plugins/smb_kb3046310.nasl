...
certs = make_array(
  '08E4987249BC450748A4A78133CBF041A3510033','COMODO RSA Domain Validation Secure Serve CA'
);
...
if (!isnull(data) && data != '')
{
  ...
  # 01d05de1256976bc (Friday, 13 March 2015 6:57:57)
  # Effective Date for KB2677070
  fixed_time = raw_string(0x01, 0xd0, 0x5d, 0xe1, 0x25, 0x69, 0x76, 0xbc);
