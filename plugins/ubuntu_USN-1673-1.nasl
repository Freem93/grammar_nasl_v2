...
# Notice USN-1673-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2012-5517");
  ...
  script_name(english:"USN-1673-1 : linux-ti-omap4 vulnerability");
...
flaw to cause a denial of service by crashing the system.");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1673-1/");
...
if (ubuntu_check(osver:"12.10", pkgname:"linux-image-3.5.0-216-omap4", pkgver:"3.5.0-216.23")) flag++;
