...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.6.0-openjdk on SL5.x, SL6.x i386/srpm/x86_64");
...
to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1407&L=scientific-linux-errata&T=0&P=1218
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?24575feb"
  );
