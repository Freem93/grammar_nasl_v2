...
if (description)
{
  ...
  script_osvdb_id(148129, 148291, 148375, 148394, 150692, 151184, 151241, 151338, 151566, 152349);
...
fixed :
  ...
  - CVE-2016-10155: The i6300esb watchdog emulation support
    ...
    host resulting in DoS (bnc#1021129) These non-security
    issues were fixed :
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2f78eff8"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
