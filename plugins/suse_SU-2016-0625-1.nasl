...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/965875"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-0739.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160625-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?08f3ac73"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
