...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux privilege-escalation vulnerability (Dirty COW) (K10558632) (Dirty COW)");
...
COW.' (CVE-2016-5195)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/#/article/K10558632"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["AVR"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.1HF2","11.5.3HF3");
...
vmatrix["PSM"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.1HF2","11.5.4HF3");
