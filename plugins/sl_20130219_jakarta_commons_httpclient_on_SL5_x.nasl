...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/02/21 11:52:10 $");

  script_cve_id("CVE-2012-5783");

  script_name(english:"Scientific Linux Security Update : jakarta-commons-httpclient on SL5.x, SL6.x i386/x86_64");
...
restarted for this update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1302&L=scientific-linux-errata&T=0&P=3348
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?33df06a4"
  );
