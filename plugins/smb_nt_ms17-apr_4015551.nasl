...
if (description)
{
  ...
  script_name(english:"KB4015551: Windows Server 2012 Standard April 2017 Cumulative Update");
  script_summary(english:"Checks the version of Quartz.dll or the installed rollup.");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update KB4015551. It is,
...
"Apply security update KB4015551.");
