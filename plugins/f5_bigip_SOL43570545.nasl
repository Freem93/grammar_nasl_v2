...
will be provided. (CVE-2016-7055)"
  );
  script_set_attribute(
    attribute:"see_also",
...
vmatrix["APM"]["unaffected"] = make_list("12.0.0","11.4.0-11.6.1","11.2.1");
...
vmatrix["AVR"]["unaffected"] = make_list("12.0.0","11.4.0-11.6.1","11.2.1");
...
vmatrix["PEM"]["unaffected"] = make_list("12.0.0","11.4.0-11.6.1");
