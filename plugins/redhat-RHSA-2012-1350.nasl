...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2012-1350.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-10.0.8-1.el5_8")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-10.0.8-1.el5_8")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"firefox-10.0.8-1.el6_3")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-10.0.8-1.el6_3")) flag++;
