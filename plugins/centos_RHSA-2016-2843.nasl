...
issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2016-December/022167.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?102fd52d"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-December/022168.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4eb42218"
  );
  # http://lists.centos.org/pipermail/centos-cr-announce/2016-December/003693.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bcdfacee"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-45.5.1-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-45.5.1-1.el6.centos")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-45.5.1-1.el7.centos")) flag++;
