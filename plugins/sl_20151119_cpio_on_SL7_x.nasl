...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : cpio on SL7.x x86_64");
...
This update fixes the following bugs :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=10232
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bd3f1585"
  );
  script_set_attribute(
    attribute:"solution", 
