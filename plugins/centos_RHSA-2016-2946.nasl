...
Pettay, Raymond Forbes, and Boris Zbarsky as the original reporters."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2016-December/022178.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?94e6ca4a"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-December/022179.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?be25213a"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-December/022180.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bbf31932"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-45.6.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-45.6.0-1.el6.centos")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-45.6.0-1.el7.centos")) flag++;
