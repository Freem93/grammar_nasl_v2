...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"143592-09", obsoleted_by:"144500-19 ", package:"SUNWipfh", version:"11.10.0,REV=2006.05.09.21.15");
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"143592-09", obsoleted_by:"144500-19 ", package:"SUNWipfu", version:"11.10.0,REV=2005.01.21.15.53");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
