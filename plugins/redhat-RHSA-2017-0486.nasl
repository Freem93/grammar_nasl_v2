...
if (description)
{
  ...
  script_name(english:"RHEL 7 : Storage Server (RHSA-2017:0486)");
...
easier to determine which client failed to connect. (BZ#1333885)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-0486.html"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-api-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-api-devel-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-cli-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-client-xlators-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-devel-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-events-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-fuse-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-ganesha-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-geo-replication-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-libs-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-rdma-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glusterfs-server-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"python-gluster-3.8.4-18.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"redhat-storage-server-3.2.0.2-1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-cli-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-debug-plugin-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-gluster-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-ethtool-options-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-faqemu-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-openstacknet-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-qemucmdline-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-infra-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-jsonrpc-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-python-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-tests-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-xmlrpc-4.17.33-1.1.el7rhgs")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-yajsonrpc-4.17.33-1.1.el7rhgs")) flag++;
