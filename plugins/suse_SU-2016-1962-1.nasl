...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/986021"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-4994.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161962-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?205276d9"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
