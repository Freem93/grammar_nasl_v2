...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mod_auth_mellon on SL6.x i386/x86_64");
...
cause the Apache HTTP Server to crash. (CVE-2014-8567)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1411&L=scientific-linux-errata&T=0&P=2421
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1c88195f"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
