...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 120412-11");
  script_summary(english:"Check for patch 120412-11");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 120412-11"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"120412-11", obsoleted_by:"", package:"SUNWcleu2", version:"10.0,REV=2004.11.27.13.33") < 0) flag++;
