...
# extracted from F5 Networks BIG-IP Solution SOL16946.
#
...
if (description)
{
  ...
  script_osvdb_id(84386);

  script_name(english:"F5 Networks BIG-IP : Boost memory allocator vulnerability (SOL16946)");
...
allocated than expected."
  );
  # http://support.f5.com/kb/en-us/solutions/public/16000/900/sol16946.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c066b50c"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
