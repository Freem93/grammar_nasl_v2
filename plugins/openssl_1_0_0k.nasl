...
reportedly affected by the following vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to OpenSSL 1.0.0k or later.");
...
openssl_check_version(fixed:'1.0.0k', min:"1.0.0", severity:SECURITY_WARNING);
