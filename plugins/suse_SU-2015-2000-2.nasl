...
if (description)
{
  ...
  script_osvdb_id(116278, 128868, 129874);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/953516"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/953519"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/953521"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2014-9756.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-7805.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-8075.html"
  );
