...
if (description)
{
  ...
  script_name(english:"Virus Infection Detection");
  script_summary(english:"Checks for the presence of different viruses on the remote host");

  script_set_attribute(attribute:'synopsis', value:"A virus has been detected on the remote host.");
...
- W32/Badtrans-B
  ...
  script_set_attribute(attribute:'solution', value:"See the URLs that will appear in the report.");
