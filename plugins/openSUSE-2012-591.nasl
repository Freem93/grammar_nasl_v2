...
"  - Fix VT100 emulation vulnerability (bnc#777084)
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-09/msg00051.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"kvm-0.14.0.0-23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"kvm-debuginfo-0.14.0.0-23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"kvm-debugsource-0.14.0.0-23.1") ) flag++;
