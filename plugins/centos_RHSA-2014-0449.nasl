...
changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1e8dd5f9"
  );
  # http://lists.centos.org/pipermail/centos-announce/2014-April/020276.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e418e8e7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-24.5.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-24.5.0-1.el6.centos")) flag++;
