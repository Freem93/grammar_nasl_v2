...
package, which contains backported patches to correct these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2013-January/019177.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c8616730"
  );
  # http://lists.centos.org/pipermail/centos-cr-announce/2013-January/000439.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f1b3f43"
  );
  script_set_attribute(
    attribute:"solution", 
