...
if (description)
{
 ...
 script_osvdb_id(30214, 33629, 34095, 34096, 34097, 34098, 34099);
...
Additionally, the system is vulnerable to :
 ...
 script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS07-017");
