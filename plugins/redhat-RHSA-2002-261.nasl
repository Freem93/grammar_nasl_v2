...
disclosure of these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2002-1158.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2002-1159.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://canna.sourceforge.jp/sec/Canna-2002-01.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2002-261.html"
  );
  script_set_attribute(
    attribute:"solution", 
