...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dovecot on SL6.x i386/srpm/x86_64");
...
restarted automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1406&L=scientific-linux-errata&T=0&P=2754
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2258968d"
  );
