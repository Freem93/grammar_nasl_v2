...
of the Adobe Flash ActiveX control that could lead to code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"http://support.microsoft.com/kb/2837385");
  script_set_attribute(attribute:"solution", value:"Install Microsoft KB2837385.");
