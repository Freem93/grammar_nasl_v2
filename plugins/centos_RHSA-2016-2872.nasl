...
These issues were discovered by Florian Weimer (Red Hat)."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2016-December/022171.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7563078d"
  );
  # http://lists.centos.org/pipermail/centos-cr-announce/2016-December/003710.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4a18ec51"
  );
