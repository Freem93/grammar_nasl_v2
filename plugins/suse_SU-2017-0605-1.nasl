...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 Security Update : compat-openssl098 (SUSE-SU-2017:0605-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170605-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b1cc46f7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
