...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 / 6 : mod_cluster (RHSA-2012:1052)");
...
for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://rhn.redhat.com/errata/RHSA-2011-1800.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://rhn.redhat.com/errata/RHSA-2011-1799.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://rhn.redhat.com/errata/RHSA-2011-1798.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2012-1052.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"mod_cluster-demo-1.0.10-4.GA_CP02_patch01.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"mod_cluster-jbossas-1.0.10-4.GA_CP02_patch01.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"mod_cluster-jbossweb2-1.0.10-4.GA_CP02_patch01.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"mod_cluster-tomcat6-1.0.10-4.GA_CP02_patch01.ep5.el4")) flag++;
