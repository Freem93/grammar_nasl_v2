...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : postgresql and postgresql84 on SL5.x i386/x86_64");
...
will be automatically restarted after installing this update."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=722
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?924ba4eb"
  );
  script_set_attribute(
    attribute:"see_also",
