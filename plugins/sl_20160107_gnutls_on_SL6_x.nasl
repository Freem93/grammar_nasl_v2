...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : gnutls on SL6.x, SL7.x i386/x86_64 (SLOTH)");
...
library must be restarted."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1601&L=scientific-linux-errata&F=&S=&P=2989
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d494875a"
  );
