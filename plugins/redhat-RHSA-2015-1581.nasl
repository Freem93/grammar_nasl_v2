...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2015-4495.html"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/articles/1563163"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-1581.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-38.1.1-1.el5_11")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-38.1.1-1.el5_11")) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-38.1.1-1.el6_7")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-38.1.1-1.el6_7")) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-38.1.1-1.el7_1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-38.1.1-1.el7_1")) flag++;
