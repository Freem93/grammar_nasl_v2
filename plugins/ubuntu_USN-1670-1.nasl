...
# Notice USN-1670-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2012-5517");
  ...
  script_name(english:"USN-1670-1 : linux-ti-omap4 vulnerability");
...
"A flaw was discovered in the Linux kernel's handling of new hot
plugged memory. An unprivileged local user could exploit this flaw to
cause a denial of service by crashing the system.");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1670-1/");
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-1423-omap4", pkgver:"3.2.0-1423.30")) flag++;
