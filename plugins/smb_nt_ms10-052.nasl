...
if (description)
{
  ...
  script_osvdb_id(66985);
  script_xref(name:"IAVA", value:"2010-A-0107");
...
subject to the user's privileges.");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS10-052");
