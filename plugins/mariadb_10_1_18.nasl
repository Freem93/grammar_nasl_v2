...
10.1.18. It is, therefore, affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb/mariadb-10118-changelog/");
...
mysql_check_version(variant:'MariaDB', fixed:'10.1.18-MariaDB', min:'10.1', severity:SECURITY_HOLE);
