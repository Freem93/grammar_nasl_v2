...
was fixed in the activerecord gem."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-08/msg00020.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"rubygem-actionpack-2_3-2.3.14-0.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"rubygem-actionpack-2_3-testsuite-2.3.14-0.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"rubygem-activerecord-2_3-2.3.14-0.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"rubygem-activerecord-2_3-testsuite-2.3.14-0.16.1") ) flag++;
