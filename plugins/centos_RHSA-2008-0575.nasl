...
contain a backported patches to resolve these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-July/015161.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8986a36b"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-July/015162.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3bd06654"
  );
  script_set_attribute(
    attribute:"solution", 
