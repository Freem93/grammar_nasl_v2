...
if (description)
{
  ...
  script_cvs_date("$Date: 2014/02/25 11:48:03 $");
...
(CVE-2013-4449)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1402&L=scientific-linux-errata&T=0&P=2450
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5835acc1"
  );
