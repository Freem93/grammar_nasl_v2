...
if (description)
{
  ...
  script_cvs_date("$Date: 2015/09/21 13:46:12 $");

  script_cve_id("CVE-2015-1270");
  script_osvdb_id(125056);
...
memory) or possibly have unspecified other impact via a crafted file."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=798647"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2015/dsa-3360"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
