...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"144891-02", obsoleted_by:"146664-02 147793-06 147715-03 ", package:"SUNWkdcu", version:"11.10.0,REV=2005.01.21.15.53");
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"144891-02", obsoleted_by:"146664-02 147793-06 147715-03 ", package:"SUNWkrbu", version:"11.10.0,REV=2005.01.21.15.53");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
