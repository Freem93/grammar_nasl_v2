...
run."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2013-January/019141.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bf743d65"
  );
  # http://lists.centos.org/pipermail/centos-cr-announce/2013-January/000333.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6dcaff73"
  );
  script_set_attribute(
    attribute:"solution", 
