...
if (description)
{
  ...
  script_cvs_date("$Date: 2011/04/25 11:05:24 $");

  script_cve_id("CVE-2007-5924");
  script_bugtraq_id(26298);
  script_osvdb_id(39720);
...
"http://www-01.ibm.com/support/docview.wss?uid=swg21263871");
  script_set_attribute(attribute:"see_also", value:
"http://www-03.ibm.com/systems/i/software/domino/support/d702fp2.html");
  script_set_attribute(attribute:"solution", value:"Upgrade to Lotus Domino 7.0.2 FP2 or later.");
