...
if (description)
{
  ...
  script_cvs_date("$Date: 2015/08/20 14:06:58 $");
...
the privileges of that application. (CVE-2014-0475)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1408&L=scientific-linux-errata&T=0&P=1436
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9824d4c7"
  );
