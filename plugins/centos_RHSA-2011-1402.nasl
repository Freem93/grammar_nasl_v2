...
restarted (log out, then log back in) for this update to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2011-November/018173.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4fa75b94"
  );
  # http://lists.centos.org/pipermail/centos-announce/2011-November/018174.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1ae99768"
  );
  # http://lists.centos.org/pipermail/centos-announce/2011-October/018133.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d9ed3ac"
  );
  # http://lists.centos.org/pipermail/centos-announce/2011-October/018134.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ae1b06c9"
  );
  script_set_attribute(
    attribute:"solution", 
