...
service vulnerability in the logging configuration of Secure Sockets
Layer (SSL) policies. An unauthenticated, remote attacker can exploit
this, via a flood of crafted TCP packets, to cause an excessive
