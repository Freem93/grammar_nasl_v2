...
e +=  solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"145802-06", obsoleted_by:"144501-19 ", package:"SUNWsshcu", version:"11.10.0,REV=2005.01.21.16.34");
e +=  solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"145802-06", obsoleted_by:"144501-19 ", package:"SUNWsshdu", version:"11.10.0,REV=2005.01.21.16.34");
e +=  solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"145802-06", obsoleted_by:"144501-19 ", package:"SUNWsshu", version:"11.10.0,REV=2005.01.21.16.34");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
