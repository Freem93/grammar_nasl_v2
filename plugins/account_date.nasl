...
if (description)
{
  ...
  script_set_attribute(attribute:"synopsis", value:"The remote host has an account with a blank password.");
  script_set_attribute(attribute:"description", value:
"The account 'date' has no password set. An attacker can leverage
this to gain access to the system.");
  script_set_attribute(attribute:"solution", value:"Set a password for this account or disable it.");
