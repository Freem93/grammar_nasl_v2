...
OpenJDK Java must be restarted for the update to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2014-January/020120.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?61e9a8d4"
  );
  # http://lists.centos.org/pipermail/centos-announce/2014-January/020121.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a171288"
  );
  script_set_attribute(
    attribute:"solution", 
