...
vmatrix["ASM"]["affected"  ] = make_list("11.0.0-11.5.3","10.0.0-10.2.4","9.2.0-9.4.8");
...
vmatrix["GTM"]["affected"  ] = make_list("11.0.0-11.5.3","10.0.0-10.2.4","9.2.2-9.4.8");
vmatrix["GTM"]["unaffected"] = make_list("11.6.0");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("11.0.0-11.5.3","10.0.0-10.2.4","9.2.2-9.4.8");
vmatrix["LC"]["unaffected"] = make_list("12.0.0","11.6.0");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("11.0.0-11.5.3","10.0.0-10.2.4","9.0.0-9.6.1");
