...
if (description)
{
  ...
  script_osvdb_id(115524, 125438, 126995, 131837);
...
the update, the BIND daemon (named) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2014-8500.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://kb.isc.org/article/AA-01216"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-0078.html"
  );
...
os_ver = os_ver[1];
if (! ereg(pattern:"^(6\.4|6\.5)([^0-9]|$)", string:os_ver)) audit(AUDIT_OS_NOT, "Red Hat 6.4 / 6.5", "Red Hat " + os_ver);
