...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.unrealircd.com/txt/unrealsecadvisory.20090413.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.unrealircd.com/txt/unrealsecadvisory.20100612.txt"
  );
  script_set_attribute(
    attribute:"see_also",
