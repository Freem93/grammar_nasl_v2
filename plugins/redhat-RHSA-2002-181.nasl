...
subscriber's list subscription options."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2002-0855.html"
  );
  # http://mail.python.org/pipermail/mailman-announce/2002-July/000043.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?604cf9c1"
  );
  # http://mail.python.org/pipermail/mailman-announce/2002-July/000045.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c59745f"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2002-181.html"
  );
  script_set_attribute(
    attribute:"solution", 
