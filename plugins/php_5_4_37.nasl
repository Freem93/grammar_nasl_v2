...
if (description)
{
  ...
  script_bugtraq_id(71833, 72539, 72541);
  script_osvdb_id(116020, 116621, 117467);
...
instead relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to PHP version 5.4.37 or later.");
