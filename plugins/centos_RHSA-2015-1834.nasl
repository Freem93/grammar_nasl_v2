...
take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2015-September/021414.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b07a3c28"
  );
  # http://lists.centos.org/pipermail/centos-announce/2015-September/021415.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d370dc67"
  );
  # http://lists.centos.org/pipermail/centos-announce/2015-September/021416.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?afed3534"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-38.3.0-2.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-38.3.0-2.el6.centos")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-38.3.0-2.el7.centos")) flag++;
