...
# extracted from F5 Networks BIG-IP Solution SOL17462.
#
...
if (description)
{
  ...
  script_osvdb_id(120284);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (SOL17462)");
...
call, as demonstrated by an attack against seccomp before 3.16."
  ...
  # http://support.f5.com/kb/en-us/solutions/public/17000/400/sol17462.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f92483d6"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
