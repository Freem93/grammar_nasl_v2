...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"138263-03", obsoleted_by:"141030-04 140391-02 142436-04 142909-17 138874-04 ", package:"SUNWcsu", version:"11.10.0,REV=2005.01.21.15.53");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
