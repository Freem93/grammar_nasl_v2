...
instead relies only on PHP's self-reported version number."
  ...
  script_set_attribute(attribute:"see_also", value:"http://bugs.php.net/66731");
  script_set_attribute(attribute:"see_also", value:"http://bugs.php.net/66815");
  script_set_attribute(attribute:"see_also", value:"http://bugs.php.net/66820");
  script_set_attribute(attribute:"solution", value:"Upgrade to PHP version 5.5.10 or later.");
