...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/982014"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-5104.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161639-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b3c3531"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
