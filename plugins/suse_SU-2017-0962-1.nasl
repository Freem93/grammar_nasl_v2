...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1024044"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1024068"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2017-5843.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2017-5848.html"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170962-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?440fc7d5"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
