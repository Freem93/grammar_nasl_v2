...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libpng on SL7.x x86_64");
...
application using the library. (CVE-2015-8126, CVE-2015-8472)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=18455
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9dbb7ac"
  );
