...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"138623-04", obsoleted_by:"146578-05 148027-03 ", package:"SUNWcsu", version:"11.10.0,REV=2005.01.21.15.53");
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"138623-04", obsoleted_by:"146578-05 148027-03 ", package:"SUNWesu", version:"11.10.0,REV=2005.01.21.15.53");
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"138623-04", obsoleted_by:"146578-05 148027-03 ", package:"SUNWxcu4", version:"11.10.0,REV=2005.01.21.15.53");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_note(0);
	else  
