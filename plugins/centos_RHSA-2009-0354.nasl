...
update to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2009-March/015681.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0926d671"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015900.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015901.html"
  );
  script_set_attribute(
    attribute:"solution", 
