...
if (description)
{
  ...
  script_set_attribute(attribute:"synopsis", value:"The remote web server contains a task list manager written in PHP.");
  script_set_attribute(attribute:"description", value:
"The remote host is running Nag, an open source PHP-based multi-user
task list manager from the Horde Project.");
  script_set_attribute(attribute:"see_also", value:"http://www.horde.org/nag/");
