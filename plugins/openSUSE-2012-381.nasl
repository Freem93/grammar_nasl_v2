...
"Changes in libgdata :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-07/msg00023.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libgdata7");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libgdata7-32bit");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libgdata7-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libgdata7-debuginfo-32bit");
...
if ( rpm_check(release:"SUSE11.4", reference:"libgdata-debugsource-0.6.6-5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libgdata-devel-0.6.6-5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libgdata-lang-0.6.6-5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libgdata7-0.6.6-5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libgdata7-debuginfo-0.6.6-5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libgdata7-32bit-0.6.6-5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libgdata7-debuginfo-32bit-0.6.6-5.1") ) flag++;
