...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : memcached on SL6.x i386/x86_64");
...
"Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1611&L=scientific-linux-errata&F=&S=&P=4456
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d10af170"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
