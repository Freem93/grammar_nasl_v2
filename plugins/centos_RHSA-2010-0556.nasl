...
the update, Firefox must be restarted for the changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2010-July/016831.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0dc4c58e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2010-July/016832.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?373d97ac"
  );
  script_set_attribute(
    attribute:"solution", 
