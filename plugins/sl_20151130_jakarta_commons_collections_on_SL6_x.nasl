...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : jakarta-commons-collections on SL6.x (noarch)");
...
restarted for the update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1511&L=scientific-linux-errata&F=&S=&P=17116
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f6e4449e"
  );
