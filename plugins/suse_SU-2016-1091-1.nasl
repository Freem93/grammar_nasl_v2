...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/973790"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-2347.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161091-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9183c775"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
