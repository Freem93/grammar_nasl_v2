...
if (description)
{
  ...
  script_osvdb_id(83692, 83693, 83694, 83695);
...
"puppet was updated to fix various security issues: CVEs fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-07/msg00036.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"puppet-2.6.17-26.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"puppet-server-2.6.17-26.1") ) flag++;
