...
if (description)
{
  ...
  script_cvs_date("$Date: 2014/03/11 11:03:48 $");

  script_name(english:"IP Protocols Scan");
  script_summary(english:"Scans IP protocols");
 
  script_set_attribute(attribute:"synopsis", value:"This plugin detects the protocols understood by the remote IP stack.");
  script_set_attribute(attribute:"description", value:"This plugin detects the protocols understood by the remote IP stack.");
