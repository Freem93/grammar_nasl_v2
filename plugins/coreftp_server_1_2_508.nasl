...
if (description)
{
  ...
  script_cvs_date("$Date: 2016/04/27 20:42:34 $");

  script_cve_id("CVE-2014-1215");
  script_bugtraq_id(65692);
  script_osvdb_id(103481);
...
arbitrary code.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://seclists.org/fulldisclosure/2014/Feb/172");
