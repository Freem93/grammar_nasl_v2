...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 Security Update : compat-openssl098 (SUSE-SU-2016:1267-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/889013"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161267-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97f4ed47"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
