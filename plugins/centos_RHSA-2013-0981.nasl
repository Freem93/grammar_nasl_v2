...
take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2013-June/019808.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ca0b3a6"
  );
  # http://lists.centos.org/pipermail/centos-announce/2013-June/019809.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fd3719c5"
  );
  # http://lists.centos.org/pipermail/centos-announce/2013-June/019816.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c5bd16e9"
  );
  # http://lists.centos.org/pipermail/centos-announce/2013-June/019818.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aad4dac4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-17.0.7-1.el5.centos")) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-17.0.7-1.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-devel-17.0.7-1.el5_9")) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-17.0.7-1.el6.centos")) flag++;
if (rpm_check(release:"CentOS-6", reference:"xulrunner-17.0.7-1.el6.centos")) flag++;
if (rpm_check(release:"CentOS-6", reference:"xulrunner-devel-17.0.7-1.el6.centos")) flag++;
