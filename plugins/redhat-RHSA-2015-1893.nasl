...
if (description)
{
  ...
  script_osvdb_id(128762, 128763, 128764, 128765, 128766, 128767, 128768, 128769, 128770, 128771, 128772, 128773, 128774, 128885, 128886, 128887, 128888, 128889, 128890, 128891, 128892);
...
which upgrades Flash Player to version 11.2.202.535."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-1893.html"
  );
  script_set_attribute(
    attribute:"solution", 
