...
"Change the password for this account or disable it.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.securityfocus.com/archive/1/535155/30/270/threaded");
...
port = check_account(login:account, password:password, cmd:'pwd', cmd_regex:'^/home/emcupdate$');
