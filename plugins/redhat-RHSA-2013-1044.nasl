...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : jboss-seam2 (RHSA-2013:1044)");
...
update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2013-1044.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"jboss-seam2-2.0.2.FP_SEC1-1.ep2.6.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jboss-seam2-docs-2.0.2.FP_SEC1-1.ep2.6.el4")) flag++;
