...
10.1.14. It is, therefore, affected by multiple vulnerabilities :
  ...
  - A flaw exists in the cost_group_min_max() function in
    ...
    service condition. (VulnDB 138528)
  ...
  - A flaw exists in the validate_password() function in
    ...
    this to crash the database, resulting in a denial of
    service condition. (VulnDB 138540)
  ...
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb/mariadb-10114-changelog/");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb/mariadb-10114-release-notes/");
...
mysql_check_version(variant:'MariaDB', fixed:'10.1.14-MariaDB', min:'10.1', severity:SECURITY_HOLE);
