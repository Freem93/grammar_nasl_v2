...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/11/05 11:44:05 $");

  script_cve_id("CVE-2012-2673");

  script_name(english:"Scientific Linux Security Update : gc on SL6.x i386/x86_64");
...
Applications using gc must be restarted for the update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1311&L=scientific-linux-errata&T=0&P=79
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f365b94"
  );
  script_set_attribute(
    attribute:"solution", 
