...
if (description)
{
  ...
  script_osvdb_id(145043, 145066, 145163, 145167, 145385, 145695, 145697, 146244, 146245, 147621, 147622, 147623, 147653, 147655, 147656, 147657, 148308);
...
fixed :
  ...
  - CVE-2016-7909: The pcnet_rdra_addr function in
    ...
    transmit descriptor ring length to 0 (bsc#1003032) This
    non-security issue wasfixed :

  - bsc#1000893: virsh setmem didn't allow to set current
    guest memory to max limit This update also delivers
    man-pages-supplement since some of the man-pages in
    there are now contained in the xen package itself.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1000893"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20163174-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3a920934"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
