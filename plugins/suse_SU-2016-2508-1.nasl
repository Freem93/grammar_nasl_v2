...
if (description)
{
  ...
  script_osvdb_id(136741, 136837, 136839, 137083, 137084);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/975070"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-3991.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162508-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2bafa9bf"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
