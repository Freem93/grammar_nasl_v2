...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-1635.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"httpd24-2.4.6-62.ep7.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"httpd24-debuginfo-2.4.6-62.ep7.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"httpd24-devel-2.4.6-62.ep7.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"httpd24-manual-2.4.6-62.ep7.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"httpd24-tools-2.4.6-62.ep7.el7")) flag++;
