...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/07/20 01:56:55 $");
...
Apache after installing this update."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-June/013984.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9e7ba632"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-June/013985.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?06b781a0"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-June/014006.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eac5d129"
  );
  script_set_attribute(
    attribute:"solution", 
