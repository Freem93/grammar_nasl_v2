...
if (description)
{
  ...
  script_osvdb_id(46187, 46188, 46189, 46190);
...
which contain backported patches to resolve these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-June/014973.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?06a76056"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-June/014974.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ada25ae"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-June/014981.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7a317ceb"
  );
  script_set_attribute(
    attribute:"solution", 
