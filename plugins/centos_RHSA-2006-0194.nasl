...
backported patch and is not vulnerable to these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2006-February/012605.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?38f38744"
  );
  # http://lists.centos.org/pipermail/centos-announce/2006-February/012608.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?948460dd"
  );
  # http://lists.centos.org/pipermail/centos-announce/2006-February/012609.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a09708cd"
  );
