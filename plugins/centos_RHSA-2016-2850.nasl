...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-45.5.1-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-45.5.1-1.el6.centos")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-45.5.1-1.el7.centos")) flag++;
