...
if (description)
{
  ...
  script_osvdb_id(69003, 69161, 69162, 69453, 69469, 69515, 69522, 69523, 69524, 69551, 69578, 69701, 69788, 70166, 70228, 70239, 70240, 70260, 70261, 70262, 70269, 70290, 70377, 70659, 70665, 71600, 71602, 71604, 71649, 71653, 71660);
...
working properly, related to (1) netback, (2) blkback, or (3) blktap."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2011-04/msg00074.html"
  );
  script_set_attribute(
    attribute:"see_also",
