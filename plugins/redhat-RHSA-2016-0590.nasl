...
if (description)
{
  ...
  script_osvdb_id(117027, 135499, 135500, 135501, 135502, 135635, 135636, 135637, 135638, 135639, 135640, 135641, 136794, 136795, 136796, 136797);
  script_xref(name:"RHSA", value:"2016:0590");

  script_name(english:"RHEL 6 : spacewalk-java (RHSA-2016:0590)");
...
CVE-2016-3079 issues were discovered by Jan Hutar (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2015-0284.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-2103.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-2104.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-3079.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-0590.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-2.3.8-134.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-config-2.3.8-134.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-lib-2.3.8-134.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-oracle-2.3.8-134.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-postgresql-2.3.8-134.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-taskomatic-2.3.8-134.el6sat")) flag++;
