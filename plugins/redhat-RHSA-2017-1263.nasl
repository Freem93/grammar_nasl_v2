...
terminated by the OOM killer. (CVE-2017-8779)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-1263.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"libtirpc-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"libtirpc-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libtirpc-debuginfo-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"libtirpc-debuginfo-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"libtirpc-debuginfo-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libtirpc-devel-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"libtirpc-devel-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"libtirpc-devel-0.2.4-0.8.el7_3")) flag++;
