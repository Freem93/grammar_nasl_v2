...
therefore, potentially affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.mozilla.org/security/announce/2014/mfsa2014-10.html");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 27.0 or later.");
