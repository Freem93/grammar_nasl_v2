...
if (description)
{
  ...
  script_name(english:"Solaris 8 (x86) : 152099-41");
...
if (solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"152099-41", obsoleted_by:"", package:"SUNWj7rtx", version:"1.7.0,REV=2011.06.27.02.48") < 0) flag++;
if (solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"152099-41", obsoleted_by:"", package:"SUNWj7dvx", version:"1.7.0,REV=2011.06.27.02.48") < 0) flag++;
if (solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"152099-41", obsoleted_by:"", package:"SUNWj7dmx", version:"1.7.0,REV=2011.06.27.02.48") < 0) flag++;
