...
if (description)
{
  ...
  script_osvdb_id(151210, 153996, 155874, 155875, 155878, 155879, 155881, 155888, 155892, 155893, 155894, 155895);
...
Patch Update advisory for further details :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=854713"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=860544"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2017/dsa-3834"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
