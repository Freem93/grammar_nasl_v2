...
service will be restarted automatically."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2013-March/019514.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4a35debb"
  );
  # http://lists.centos.org/pipermail/centos-cr-announce/2013-February/000706.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?27092c7d"
  );
