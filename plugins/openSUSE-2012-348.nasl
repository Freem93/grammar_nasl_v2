...
if (description)
{
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-07/msg00001.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"socat-1.7.1.3-6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"socat-debuginfo-1.7.1.3-6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"socat-debugsource-1.7.1.3-6.1") ) flag++;
