...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : jakarta-commons-collections on SL5.x i386/x86_64");
...
restarted for the update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=3803
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ac7fd045"
  );
