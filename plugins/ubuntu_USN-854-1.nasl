...
if (description)
{
  ...
  script_osvdb_id(37741, 37742, 42062, 58187, 59071);
...
without introducing additional issues."
  ...
  script_copyright(english:"Ubuntu Security Notice (C) 2009-2017 Canonical, Inc. / NASL script (C) 2009-2017 Tenable Network Security, Inc.");
