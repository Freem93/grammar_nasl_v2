...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/03/26 10:59:47 $");

  script_cve_id("CVE-2012-5784");

  script_name(english:"Scientific Linux Security Update : axis on SL5.x i386/x86_64");
...
take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1303&L=scientific-linux-errata&T=0&P=5784
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?51586e37"
  );
