...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2014-8641.html"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-0046.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-31.4.0-1.el5_11")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-31.4.0-1.el5_11")) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-31.4.0-1.el6_6")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-31.4.0-1.el6_6")) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-31.4.0-1.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-31.4.0-1.el7_0")) flag++;
