...
if (description)
{
  ...
  script_name(english:"RHEL 6 : rhev-hypervisor (RHSA-2017:1209)");
...
extensions."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-1209.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rhev-hypervisor7-7.3-20170425.0.el6ev")) flag++;
