...
to bypass Java Sandbox restrictions. (CVE-2016-0636)"
  ...
  # http://lists.centos.org/pipermail/centos-announce/2016-March/021775.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1052998b"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-March/021777.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e2de98c"
  );
  script_set_attribute(
    attribute:"solution", 
