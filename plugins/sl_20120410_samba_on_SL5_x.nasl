...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : samba on SL5.x, SL6.x i386/x86_64");
...
this update, the smb service will be restarted automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1204&L=scientific-linux-errata&T=0&P=972
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?788eabbf"
  );
