...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dhcp on SL5.x i386/x86_64");
...
update, all DHCP servers will be restarted automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1208&L=scientific-linux-errata&T=0&P=997
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ff9f242"
  );
