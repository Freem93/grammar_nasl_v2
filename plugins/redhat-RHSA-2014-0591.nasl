...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 / 6 : JBoss EAP (RHSA-2014:0591)");
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://issues.jboss.org/browse/JBPAPP-10991"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2014-0591.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL4", rpm:"xalan-j2-") || rpm_exists(release:"RHEL5", rpm:"xalan-j2-") || rpm_exists(release:"RHEL6", rpm:"xalan-j2-"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "JBoss EAP");

  if (rpm_check(release:"RHEL4", reference:"xalan-j2-2.7.1-12_patch_08.ep5.el4")) flag++;
