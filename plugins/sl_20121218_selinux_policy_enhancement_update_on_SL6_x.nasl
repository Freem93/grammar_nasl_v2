...
if (description)
{
  ...
  script_cvs_date("$Date: 2012/12/19 11:59:05 $");
...
bugs."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1212&L=scientific-linux-errata&T=0&P=915
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4223388d"
  );
