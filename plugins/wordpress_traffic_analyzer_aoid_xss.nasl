...
executed within the security context of the affected site.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d993ffe5");
  script_set_attribute(attribute:"see_also", value:"http://wordpress.org/plugins/trafficanalyzer/changelog/");
  script_set_attribute(attribute:"solution", value:"Upgrade to version 3.4.0 or later.");
