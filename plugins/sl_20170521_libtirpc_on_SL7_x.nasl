...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libtirpc on SL7.x x86_64");
...
"Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1705&L=scientific-linux-errata&F=&S=&P=5217
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6888bed0"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
