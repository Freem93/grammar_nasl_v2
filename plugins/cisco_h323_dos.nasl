...
potentially execute arbitrary code." );
 ...
 script_set_attribute(
   attribute:"see_also",
   value:"http://www.nessus.org/u?767c198a"
 );
 script_set_attribute(
   attribute:"solution", 
 ...
 script_cvs_date("$Date: 2013/03/15 21:39:58 $");
 ...
 script_copyright(english:"This script is (C) 2004-2013 Tenable Network Security, Inc.");
