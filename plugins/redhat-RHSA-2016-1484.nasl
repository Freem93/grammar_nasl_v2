...
if (description)
{
  ...
  script_osvdb_id(136797, 140222);
  script_xref(name:"RHSA", value:"2016:1484");

  script_name(english:"RHEL 6 : spacewalk-java (RHSA-2016:1484)");
...
These issues were discovered by Jan Hutar (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-3080.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-3097.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-1484.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-2.3.8-147.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-config-2.3.8-147.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-lib-2.3.8-147.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-oracle-2.3.8-147.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-java-postgresql-2.3.8-147.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", reference:"spacewalk-taskomatic-2.3.8-147.el6sat")) flag++;
