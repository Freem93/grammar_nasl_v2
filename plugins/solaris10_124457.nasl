...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 124457-03");
  script_summary(english:"Check for patch 124457-03");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 124457-03"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"124457-03", obsoleted_by:"", package:"SUNWxwopt", version:"6.6.2.7400,REV=0.2004.12.15") < 0) flag++;
