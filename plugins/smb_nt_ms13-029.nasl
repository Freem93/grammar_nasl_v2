...
arbitrary code subject to the user's privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.zerodayinitiative.com/advisories/ZDI-13-065/");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms13-029");
  script_set_attribute(
    attribute:"solution",
    value:
