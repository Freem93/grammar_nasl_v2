...
if (description)
{
  ...
  script_osvdb_id(81126, 81127, 81128, 81129, 81130);
...
host.");
  script_set_attribute(attribute:"see_also", value:"http://www.zerodayinitiative.com/advisories/ZDI-12-065/");
  script_set_attribute(attribute:"see_also", value:"http://www.securityfocus.com/archive/1/522394/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms12-023");
  script_set_attribute(
    attribute:"solution",
    value:
