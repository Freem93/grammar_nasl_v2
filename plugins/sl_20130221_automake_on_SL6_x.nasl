...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : automake on SL6.x (noarch)");
...
distcheck'. (CVE-2012-3386)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1302&L=scientific-linux-errata&T=0&P=5162
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bba98eb4"
  );
  script_set_attribute(
    attribute:"solution", 
