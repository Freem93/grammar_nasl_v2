...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.glpi-project.org/spip.php?page=annonce&id_breve=304&lang=en"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.glpi-project.org/spip.php?page=annonce&id_breve=306&lang=en"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.glpi-project.org/spip.php?page=annonce&id_breve=308&lang=en"
  );
  script_set_attribute(
    attribute:"see_also",
