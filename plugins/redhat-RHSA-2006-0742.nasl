...
Enterprise Linux 2.1."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2006-5925.html"
  );
  # http://marc.theaimsgroup.com/?&m=116355556512780
  script_set_attribute(
    attribute:"see_also",
    value:"http://marc.info/?&m=116355556512780"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2006-0742.html"
  );
  script_set_attribute(
    attribute:"solution", 
