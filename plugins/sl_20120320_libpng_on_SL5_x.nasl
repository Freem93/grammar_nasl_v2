...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libpng on SL5.x, SL6.x i386/x86_64");
...
to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1203&L=scientific-linux-errata&T=0&P=1730
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c04f4f27"
  );
