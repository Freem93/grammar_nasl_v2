...
security issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-08/msg00027.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"flash-player-11.2.202.238-20.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"flash-player-gnome-11.2.202.238-20.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"flash-player-kde4-11.2.202.238-20.1") ) flag++;
