...
if (description)
{
  ...
  script_osvdb_id(60972, 61234, 61718, 99240);
...
advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?06c40a7a"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://tools.ietf.org/html/rfc5746"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://devcentral.f5.com/wiki/iRules.ssl__renegotiate.ashx"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
