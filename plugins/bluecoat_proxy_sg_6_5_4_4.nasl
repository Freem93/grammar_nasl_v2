...
if (description)
{
  ...
  script_set_attribute(attribute:"synopsis", value:"The remote device is potentially affected by multiple vulnerabilities.");
...
affected by the following vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to version 6.5.4.4 or later.");
