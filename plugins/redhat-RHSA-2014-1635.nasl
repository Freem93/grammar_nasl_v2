...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2014-1576.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2014-1583.html"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2014-1635.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-31.2.0-3.el5_11")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-31.2.0-3.el5_11")) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-31.2.0-3.el6_6")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-31.2.0-3.el6_6")) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-31.2.0-3.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-31.2.0-3.el7_0")) flag++;
