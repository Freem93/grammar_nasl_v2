...
proxying HTTP and HTTPS connections respectively."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?217e09d2"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-November/022158.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?783a72eb"
  );
  # http://lists.centos.org/pipermail/centos-cr-announce/2016-November/003678.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3ccc3b3a"
  );
  script_set_attribute(
    attribute:"solution", 
