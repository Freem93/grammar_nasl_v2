...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2012-0079.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"firefox-3.6.26-2.el4")) flag++;


  if (rpm_check(release:"RHEL5", reference:"firefox-3.6.26-1.el5_7")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"firefox-3.6.26-1.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-3.6.26-1.el6_2")) flag++;
