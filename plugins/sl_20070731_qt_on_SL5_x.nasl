...
if (description)
{
  ...
  script_cvs_date("$Date: 2014/05/06 11:35:46 $");
...
(CVE-2007-3388)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind0708&L=scientific-linux-errata&T=0&P=203
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b5476101"
  );
