...
# Notice USN-1319-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2011-1162", "CVE-2011-2203", "CVE-2011-3353", "CVE-2011-4110");
  ...
  script_name(english:"USN-1319-1 : linux-ti-omap4 vulnerabilities");
...
system. (CVE-2011-4110)");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1319-1/");
...
if (ubuntu_check(osver:"11.04", pkgname:"linux-image-2.6.38-1209-omap4", pkgver:"2.6.38-1209.20")) flag++;
