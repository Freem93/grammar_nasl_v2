...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 143049-02");
  script_summary(english:"Check for patch 143049-02");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 143049-02"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"143049-02", obsoleted_by:"", package:"SUNWscebs:3.1.1,REV=07.17.03,20:04", version:"33") < 0) flag++;
