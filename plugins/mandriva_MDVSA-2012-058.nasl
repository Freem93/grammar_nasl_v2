...
The updated packages have been patched to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://curl.haxx.se/docs/adv_20120124.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://curl.haxx.se/docs/manpage.html#--ssl-allow-beast"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://curl.haxx.se/libcurl/c/curl_easy_setopt.html#CURLOPTSSLOPTIONS"
  );
  script_set_attribute(
    attribute:"see_also",
