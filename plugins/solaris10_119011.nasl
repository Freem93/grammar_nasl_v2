...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 119011-01");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119011-01", obsoleted_by:"116271-07 ", package:"VRTSnetbp", version:"5.1,REV=2004.05.11.17.55") < 0) flag++;
