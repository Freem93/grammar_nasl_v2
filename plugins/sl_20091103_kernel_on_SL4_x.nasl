...
if (description)
{
  ...
  script_cvs_date("$Date: 2015/02/02 15:49:15 $");
...
The system must be rebooted for this update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind0911&L=scientific-linux-errata&T=0&P=476
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8378873d"
  );
