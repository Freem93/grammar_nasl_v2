...
contains a backported patch and is not vulnerable to this issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2005-September/012144.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?debc91ce"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-September/012148.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?569de6ed"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-September/012149.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?86e51cd3"
  );
  script_set_attribute(
    attribute:"solution", 
