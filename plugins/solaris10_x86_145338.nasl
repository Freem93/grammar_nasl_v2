...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 145338-04");
  script_summary(english:"Check for patch 145338-04");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 145338-04"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"145338-04", obsoleted_by:"", package:"SUNWscs1mq", version:"3.3.0,REV=2010.07.26.12.57") < 0) flag++;
