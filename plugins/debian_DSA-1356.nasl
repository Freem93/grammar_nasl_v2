...
if (description)
{
  ...
  script_osvdb_id(34739, 35929, 37112, 37114, 37116, 37117, 37120, 37121, 37124, 37289);
...
compatibility with or to take advantage of this update :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2007/dsa-1356"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
need to rebuild to take advantage of these fixes."
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2007/04/20");
