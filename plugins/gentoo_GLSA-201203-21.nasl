...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://downloads.asterisk.org/pub/security/AST-2012-002.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://downloads.asterisk.org/pub/security/AST-2012-003.txt"
  );
  script_set_attribute(
    attribute:"see_also",
