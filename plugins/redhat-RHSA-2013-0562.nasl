...
all nodes for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2013-0562.html"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"python-qpid-qmf-0.18-15.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"python-qpid-qmf-0.18-15.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"python-saslwrapper-0.18-1.el6_3")) flag++;
  ...
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-cpp-client-devel-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-cpp-client-devel-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"qpid-cpp-client-devel-docs-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-cpp-client-rdma-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-cpp-client-rdma-0.18-14.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-cpp-server-cluster-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-cpp-server-cluster-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-cpp-server-devel-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-cpp-server-devel-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-cpp-server-rdma-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-cpp-server-rdma-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-cpp-server-ssl-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-cpp-server-ssl-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-cpp-server-store-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-cpp-server-store-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-cpp-server-xml-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-cpp-server-xml-0.18-14.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"qpid-java-client-0.18-7.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"qpid-java-common-0.18-7.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"qpid-java-example-0.18-7.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"qpid-jca-0.18-8.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"qpid-jca-xarecovery-0.18-8.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"qpid-qmf-devel-0.18-15.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qpid-qmf-devel-0.18-15.el6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"rhm-docs-0.18-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ruby-qpid-qmf-0.18-15.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ruby-qpid-qmf-0.18-15.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ruby-saslwrapper-0.18-1.el6_3")) flag++;
