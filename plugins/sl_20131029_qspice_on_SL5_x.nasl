...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/11/05 11:41:03 $");
...
server could use this flaw to crash the application. (CVE-2013-4282)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1310&L=scientific-linux-errata&T=0&P=3301
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e536d688"
  );
