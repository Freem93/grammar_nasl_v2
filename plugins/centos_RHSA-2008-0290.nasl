...
contain a backported patch to resolve these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-June/015038.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5cf775da"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-June/015039.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?020a0500"
  );
  script_set_attribute(
    attribute:"solution", 
