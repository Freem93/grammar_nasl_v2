...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1007188"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/913058"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-6321.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162896-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3c7efeec"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
