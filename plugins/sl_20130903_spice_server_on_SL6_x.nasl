...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/09/05 10:47:42 $");
...
console access must be restarted for this update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1309&L=scientific-linux-errata&T=0&P=195
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?62ee4211"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
