...
# extracted from F5 Networks BIG-IP Solution SOL62012529.
#
...
if (description)
{
  ...
  script_osvdb_id(135664);

  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (SOL62012529)");
...
record, related to db.c and resolver.c."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.f5.com/kb/en-us/solutions/public/k/62/sol62012529.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://f5.com/support/tools/ihealth"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade to one of the non-vulnerable versions listed in the F5
Solution SOL62012529."
  );
