...
if (description)
{
  ...
  script_summary(english:"Check for patch 149079-03");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 149079-03"
  );
  script_set_attribute(
...
Date this patch was last updated by Sun : Sep/30/14"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/149079-03"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/149079-01"
  );
  script_set_attribute(
    attribute:"solution", 
