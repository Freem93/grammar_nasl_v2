...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2013-1476.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-17.0.10-1.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-17.0.10-1.el5_10")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"firefox-17.0.10-1.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-17.0.10-1.el6_4")) flag++;
