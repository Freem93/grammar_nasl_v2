...
# Notice USN-1742-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2013-0871");
  ...
  script_name(english:"USN-1742-1 : linux-ti-omap4 vulnerability");
...
as an administrator.");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1742-1/");
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-1426-omap4", pkgver:"3.2.0-1426.35")) flag++;
