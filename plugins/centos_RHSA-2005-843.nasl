...
contain backported patches that resolve these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2005-December/012480.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fe7522f6"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-December/012481.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fd9c657f"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-December/012489.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd052487"
  );
  script_set_attribute(
    attribute:"solution", 
