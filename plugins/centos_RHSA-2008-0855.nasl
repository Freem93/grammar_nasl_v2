...
unintended access to a users local X server. (CVE-2007-4752)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f6b2c93"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-August/015194.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d2789739"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-August/015200.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?187db04a"
  );
  script_set_attribute(
    attribute:"solution", 
