...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-2550.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"libxml2-2.9.1-6.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libxml2-debuginfo-2.9.1-6.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libxml2-devel-2.9.1-6.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"libxml2-python-2.9.1-6.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"libxml2-python-2.9.1-6.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libxml2-static-2.9.1-6.el7_2.2")) flag++;
