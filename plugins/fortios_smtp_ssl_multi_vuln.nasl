...
vulnerabilities :
  ...
  - An unspecified flaw exists in the SSL renegotiation
    ...
    (VulnDB 125029)");
  # http://kb.fortinet.com/kb/microsites/search.do?cmd=displayKC&docType=kc&externalId=FortiOS-v50-Patch-Release-2-Release-Notespdf
  script_set_attribute(attribute:"see_also",value:"http://www.nessus.org/u?e6fcb35d");
