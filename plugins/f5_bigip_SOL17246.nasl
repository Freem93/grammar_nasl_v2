...
# extracted from F5 Networks BIG-IP Solution SOL17246.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (SOL17246)");
...
system call after a disconnect."
  ...
  # http://support.f5.com/kb/en-us/solutions/public/17000/200/sol17246.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77e94036"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["APM"]["unaffected"] = make_list("12.1.0","12.0.0HF1","11.0.0","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0","11.1.0-11.6.0");
vmatrix["ASM"]["unaffected"] = make_list("12.1.0","12.0.0HF1","11.0.0","10.1.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0","11.1.0-11.6.0");
vmatrix["AVR"]["unaffected"] = make_list("12.1.0","12.0.0HF1","11.0.0");
...
vmatrix["LC"]["unaffected"] = make_list("12.1.0","12.0.0HF1","11.0.0","10.1.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0","11.1.0-11.6.0");
vmatrix["LTM"]["unaffected"] = make_list("12.1.0","12.0.0HF1","11.0.0","10.1.0-10.2.4");
