...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 119777-19");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119777-19", obsoleted_by:"121581-12 ", package:"SUNWcomic", version:"1.0,REV=2003.10.29") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119777-19", obsoleted_by:"121581-12 ", package:"SUNWcomis", version:"1.0,REV=2003.10.29") < 0) flag++;
