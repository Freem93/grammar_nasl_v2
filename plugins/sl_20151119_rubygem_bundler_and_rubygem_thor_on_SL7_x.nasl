...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : rubygem-bundler and rubygem-thor on SL7.x (noarch)");
...
bug fixes and enhancements over the previous versions."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=10563
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e8eda8af"
  );
