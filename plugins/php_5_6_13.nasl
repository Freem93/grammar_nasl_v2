...
multiple vulnerabilities :
  ...
  - An flaw exists in the XSLTProcessor class due to
  ...
  - A NULL pointer dereference flaw exists in the
    ...
    cause a PHP application to crash. (VulnDB 127124)
