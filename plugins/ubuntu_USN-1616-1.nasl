...
if (description)
{
  ...
  script_osvdb_id(53373, 64957, 65151, 79249, 80009, 82462, 84757);
...
if (! ereg(pattern:"^(10\.04|11\.04)$", string:release)) audit(AUDIT_OS_NOT, "Ubuntu 10.04 / 11.04", "Ubuntu " + release);
