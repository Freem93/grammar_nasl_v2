...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/03/06 11:48:05 $");
...
rpms."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind0908&L=scientific-linux-errata&T=0&P=1352
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7fce6384"
  );
  script_set_attribute(
    attribute:"solution", 
