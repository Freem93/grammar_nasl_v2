...
contains backported patches to correct this issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-July/014026.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?be38c92d"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-July/014038.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c902a604"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-July/014039.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5020cf08"
  );
  script_set_attribute(
    attribute:"solution", 
