...
changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2013-January/019049.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00ea7fc7"
  );
  # http://lists.centos.org/pipermail/centos-announce/2013-January/019201.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1896738e"
  );
  # http://lists.centos.org/pipermail/centos-cr-announce/2013-January/000465.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a156f9d4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-10.0.12-3.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-10.0.12-3.el6.centos")) flag++;
