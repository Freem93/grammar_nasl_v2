...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 136864-01");
  script_summary(english:"Check for patch 136864-01");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 136864-01");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"136864-01", obsoleted_by:"127656-04 ", package:"SYMCnetbp", version:"6.5,REV=2007.07.24.03.39") < 0) flag++;
