...
# Notice USN-1679-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2012-5517");
  ...
  script_name(english:"USN-1679-1 : linux-ti-omap4 vulnerability");
...
hot-plugged memory. An unprivileged local user could exploit this
flaw to cause a denial of service by crashing the system.");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1679-1/");
...
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-1219-omap4", pkgver:"3.0.0-1219.32")) flag++;
