...
may not be preserved unless the configuration is explictly saved. This
will leave the system in a state where it still accepts the old
password, and the new password cannot be used to log in.

This vulnerability occurs when all of the following conditions are 
met :

You have upgraded your system to BIG-IP 11.0.0 through 12.0.0.

You reboot the BIG-IP system for the first time.
...
including system reboot, mcpd process restarting, and license
installation."
  );
  script_set_attribute(
    attribute:"see_also",
...
vmatrix["APM"]["unaffected"] = make_list("10.2.1-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1","11.2.1");
vmatrix["ASM"]["unaffected"] = make_list("10.2.1-10.2.4");
...
vmatrix["LC"]["unaffected"] = make_list("10.2.1-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1","11.2.1");
vmatrix["LTM"]["unaffected"] = make_list("10.2.1-10.2.4");
