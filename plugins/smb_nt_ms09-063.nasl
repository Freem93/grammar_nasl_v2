...
if (description)
{
  ...
  script_osvdb_id(59865);
  script_xref(name:"IAVA", value:"2009-A-0115");
...
could exploit this to take complete control of the system."
  ...
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS09-063");
  script_set_attribute(
    attribute:"solution",
