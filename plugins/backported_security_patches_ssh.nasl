...
"Security patches may have been 'backported' to the remote SSH server
...
security problem.");
 ...
 script_dependencie("global_settings.nasl", "ssh_detect.nasl", "ssh_get_info.nasl");
 exit(0);
}
...
else exit(0, "The SSH server listening on port "+port+" does not appear to have backported security patches.");
