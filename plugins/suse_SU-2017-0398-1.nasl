...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1004221"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-8605.html"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170398-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?87c678d7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
