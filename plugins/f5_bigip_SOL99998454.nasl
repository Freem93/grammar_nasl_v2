...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"An undisclosed iControl REST worker fails to fully sanitize
parameters, which can lead to disclosure of information through a
maliciously crafted query. (CVE-2016-5021)"
  );
  script_set_attribute(
    attribute:"see_also",
