...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : automake on SL5.x (noarch)");
...
distcheck'. (CVE-2012-3386)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1409&L=scientific-linux-errata&T=0&P=2249
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?645fb402"
  );
  script_set_attribute(
    attribute:"solution", 
