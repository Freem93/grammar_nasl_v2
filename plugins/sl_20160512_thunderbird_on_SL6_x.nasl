...
Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1606&L=scientific-linux-errata&F=&S=&P=3306
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4016c52b"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-38.8.0-2.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-38.8.0-2.el6_8")) flag++;
