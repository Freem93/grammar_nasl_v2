...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/03/15 10:50:35 $");
...
The system must be rebooted for this update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1303&L=scientific-linux-errata&T=0&P=4386
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?782cb4bf"
  );
