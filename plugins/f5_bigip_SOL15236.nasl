...
# extracted from F5 Networks BIG-IP Solution SOL15236.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : ConfigSync IP Rsync full file system access vulnerability (SOL15236)");
  ...
  script_set_attribute(
    ...
    value:
"An open Rsync configuration for the ConfigSync IP address allows for
remote read/write file system access in BIG-IP 11.x versions before
11.6.0, 11.5.1 HF3, 11.5.0 HF4, 11.4.1 HF4, 11.4.0 HF7, 11.3.0 HF9,
and 11.2.1 HF11, and Enterprise Manager 3.x versions before 3.1.1 HF2."
  );
  # http://support.f5.com/kb/en-us/solutions/public/15000/200/sol15236.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c5d7c6b5"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
