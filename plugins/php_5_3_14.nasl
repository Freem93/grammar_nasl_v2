...
if (description)
{
  ...
  script_bugtraq_id(47545, 53729, 54777, 57462);
  script_osvdb_id(72399, 82510, 82931, 89424);
...
affected the following vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to PHP version 5.3.14 or later.");
