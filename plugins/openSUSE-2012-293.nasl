...
properly"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-05/msg00036.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"sudo-1.7.6p2-0.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"sudo-debuginfo-1.7.6p2-0.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"sudo-debugsource-1.7.6p2-0.13.1") ) flag++;
