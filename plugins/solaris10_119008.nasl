...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 119008-01");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119008-01", obsoleted_by:"119009-02 ", package:"VRTSnetbp", version:"6.0,REV=2005.09.07.19.13") < 0) flag++;
