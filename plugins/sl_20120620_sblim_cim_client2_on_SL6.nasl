...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sblim-cim-client2 on SL6.x");
...
packages, which contain a backported patch to resolve this issue."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=1390
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?99d7daea"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
