...
changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2016-March/021738.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?40c38446"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-March/021739.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aedf069d"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-March/021740.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d9dd53ec"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-38.7.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-38.7.0-1.el6.centos")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-38.7.0-1.el7.centos")) flag++;
