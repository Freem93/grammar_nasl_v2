...
if (description)
{
  ...
  script_osvdb_id(101995, 101996, 101997, 102001, 102002, 102003, 102004, 102005, 102006, 102007, 102008, 102013, 102014, 102015, 102016, 102017, 102018, 102019, 102020, 102021, 102023, 102024, 102025, 102027, 102028);
...
instances of IBM Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2014-0135.html"
  );
