...
# Notice USN-1459-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2012-1601", "CVE-2012-2123");
  ...
  script_name(english:"USN-1459-1 : linux-ti-omap4 vulnerabilities");
...
privileges easier. (CVE-2012-2123)");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1459-1/");
...
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-1210-omap4", pkgver:"3.0.0-1210.22")) flag++;
