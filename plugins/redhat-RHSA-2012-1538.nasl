...
Solution section for details."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2012-3525.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2012-1538.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
else
{
  ...
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"jabberd-2.2.8-20.el5sat")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"jabberd-2.2.8-20.el5sat")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"jabberd-2.2.8-20.el6sat")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"jabberd-2.2.8-20.el6sat")) flag++;
