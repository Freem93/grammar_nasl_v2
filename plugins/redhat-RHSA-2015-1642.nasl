...
if (description)
{
  ...
  script_osvdb_id(120601, 121622);
  script_xref(name:"RHSA", value:"2015:1642");

  script_name(english:"RHEL 5 / 6 : JBoss Web Server (RHSA-2015:1642)");
...
update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-1642.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
else
{
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mod_cluster-native / mod_jk-ap22 / mod_jk-manual");
  }
}
