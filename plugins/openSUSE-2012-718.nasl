...
potential DoS attack"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-10/msg00062.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"hostapd-0.6.10-9.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"hostapd-debuginfo-0.6.10-9.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"hostapd-debugsource-0.6.10-9.1") ) flag++;
