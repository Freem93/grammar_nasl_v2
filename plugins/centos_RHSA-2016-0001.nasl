...
changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2016-January/021588.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1ecec90c"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-January/021589.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?511a30d2"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-January/021590.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00e8715b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-38.5.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-38.5.0-1.el6.centos")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-38.5.0-1.el7.centos")) flag++;
