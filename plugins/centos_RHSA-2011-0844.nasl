...
effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2011-June/017607.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b467a9c"
  );
  # http://lists.centos.org/pipermail/centos-announce/2011-June/017608.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6bd1ca2e"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.centos.org/pipermail/centos-announce/2011-May/017593.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.centos.org/pipermail/centos-announce/2011-May/017594.html"
  );
