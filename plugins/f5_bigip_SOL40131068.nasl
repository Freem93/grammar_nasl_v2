...
# extracted from F5 Networks BIG-IP Solution K40131068.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : GnuPG vulnerability (K40131068)");
...
(infinite recursion) via a crafted OpenPGP message. (CVE-2013-4402)"
  );
  script_set_attribute(
    attribute:"see_also",
