...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"Invalid length data provided by a custom refclock driver could cause a
buffer overflow. ** RESERVED ** This candidate has been reserved by an
...
for this candidate will be provided. (CVE-2015-7853)"
  );
  script_set_attribute(
    attribute:"see_also",
