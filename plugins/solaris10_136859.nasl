...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 136859-02");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"136859-02", obsoleted_by:"", package:"VRTSnetbp", version:"6.0,REV=2005.09.07.19.13") < 0) flag++;
