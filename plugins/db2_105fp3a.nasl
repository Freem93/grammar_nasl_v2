...
one or more of the following vulnerabilities :
  ...
  # Security Fix List
  script_set_attribute(attribute:"see_also", value:"http://www.ibm.com/support/docview.wss?uid=swg21647054");
  # Downloads
...
if (platform == 5 || platform == 23)
{
  ...
  if (ver_compare(ver:level, fix:fixed_level) == -1)
    report =
      ...
      '\n  Fixed level     : ' + fixed_level + ' (10.5 Fix Pack 3a)\n';
...
)
{
  ...
  if (ver_compare(ver:level, fix:fixed_level) <= 0)
    report =
      '\n  Platform        : ' + platform_name +
      '\n  Installed level : ' + level +
      '\n  Fixed level     : 10.5.0.3a (10.5 Fix Pack 3a)\n';
