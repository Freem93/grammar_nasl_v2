...
if (description)
{
  ...
  script_cve_id("CVE-2015-7576", "CVE-2015-7577", "CVE-2016-0751", "CVE-2016-0752");

  script_name(english:"openSUSE Security Update : rubygem-actionpack-3_2 / rubygem-activesupport-3_2 (openSUSE-2016-160)");
  script_summary(english:"Check for the openSUSE-2016-160 patch");
...
fixes the following issues :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected rubygem-actionpack-3_2 / rubygem-activesupport-3_2 packages."
  );
