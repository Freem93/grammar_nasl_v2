...
changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c44d6133"
  );
  # http://lists.centos.org/pipermail/centos-announce/2014-June/020366.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f1f0062"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-24.6.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-24.6.0-1.el6.centos")) flag++;
