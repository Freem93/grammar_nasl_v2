...
if (description)
{
  ...
  script_cvs_date("$Date: 2014/01/09 02:11:07 $");

  script_bugtraq_id(61903);
  script_osvdb_id(96463, 96464);
...
multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Serv-U version 15.0.0.0 or later.");
