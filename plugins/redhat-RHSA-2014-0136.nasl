...
if (description)
{
  ...
  script_cve_id("CVE-2013-5907", "CVE-2014-0368", "CVE-2014-0373", "CVE-2014-0376", "CVE-2014-0411", "CVE-2014-0416", "CVE-2014-0417", "CVE-2014-0422", "CVE-2014-0423", "CVE-2014-0428");
  script_bugtraq_id(64894, 64907, 64914, 64918, 64921, 64922, 64930, 64932, 64935, 64937);
  script_osvdb_id(101995, 101996, 101997, 102001, 102003, 102008, 102017, 102018, 102019, 102028);
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2014-0136.html"
  );
