...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 126364-10");
  script_summary(english:"Check for patch 126364-10");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 126364-10"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"126364-10", obsoleted_by:"", package:"SUNWxwts", version:"6.6.2.4099,REV=0.2006.10.13") < 0) flag++;
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"126364-10", obsoleted_by:"", package:"SUNWxorg-tsol-module", version:"6.8.0.5.10.0000,REV=0.2006.10.13") < 0) flag++;
