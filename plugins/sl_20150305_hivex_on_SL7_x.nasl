...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : hivex on SL7.x x86_64");
...
This update also fixes the following bugs :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1503&L=scientific-linux-errata&T=0&P=1920
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d1ed673"
  );
