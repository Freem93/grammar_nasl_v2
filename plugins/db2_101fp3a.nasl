...
if (description)
{
  ...
  script_cve_id("CVE-2013-0169", "CVE-2013-6747", "CVE-2014-0907", "CVE-2014-0963");
  script_bugtraq_id(57778, 65156, 67238, 67617);
  script_osvdb_id(89848, 102556, 106786, 107413);
...
if (platform == 5 || platform == 23)
{
  ...
  if (ver_compare(ver:level, fix:fixed_level) == -1)
    report =
      ...
      '\n  Fixed level     : 10.1.301.770 (10.1 Fix Pack 3a) / 10.1.400.766 (10.1 Fix Pack 4)\n';
}
# Others
else if (
...
)
{
  ...
  if (ver_compare(ver:level, fix:fixed_level) <= 0)
    report =
      '\n  Platform        : ' + platform_name +
      '\n  Installed level : ' + level +
      '\n  Fixed level     : 10.1.0.3a (10.1 Fix Pack 3a) / 10.1.0.4 (10.1 Fix Pack 4)\n';
