...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libreport on SL6.x i386/x86_64");
...
Linux as they do not post data to Red Hat Bugzilla."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1511&L=scientific-linux-errata&F=&S=&P=16326
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?507975b2"
  );
