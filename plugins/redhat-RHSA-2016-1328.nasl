...
if (description)
{
  ...
  script_osvdb_id(140445);
  script_xref(name:"RHSA", value:"2016:1328");

  script_name(english:"RHEL 4 / 5 / 6 : JBoss EAP (RHSA-2016:1328)");
...
The CVE-2016-2141 issue was discovered by Dennis Reed (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-1328.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
else
{
  ...
  if (rpm_check(release:"RHEL4", reference:"jgroups-2.6.22-2.ep5.el4")) flag++;
