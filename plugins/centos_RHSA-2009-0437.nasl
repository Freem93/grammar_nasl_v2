...
restarted for the changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2009-April/015822.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ddee350f"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015906.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.centos.org/pipermail/centos-announce/2009-May/015907.html"
  );
  script_set_attribute(
    attribute:"solution", 
