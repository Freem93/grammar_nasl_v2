...
# Notice USN-1645-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2012-0957", "CVE-2012-4565");
  ...
  script_name(english:"USN-1645-1 : linux-ti-omap4 vulnerabilities");
...
cause a denial of service. (CVE-2012-4565)");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1645-1/");
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-1422-omap4", pkgver:"3.2.0-1422.29")) flag++;
