...
if (description)
{
  ...
  script_osvdb_id(134630, 134631, 139049, 139050, 139051, 139178, 139179, 139237, 139324, 139518, 139575, 139576, 142178, 142203, 142870, 142873, 143254, 143611, 143827, 143828);
...
fixed :
  ...
  - CVE-2016-7156: In the VMWARE PVSCSI paravirtual SCSI bus
    ...
    DoS (bsc#997859) This non-security issue was fixed :
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1000048"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162589-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?01cb6500"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
