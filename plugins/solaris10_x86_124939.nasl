...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 124939-05");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"124939-05", obsoleted_by:"", package:"SUNWjdmk-base", version:"5.1,REV=34.20060120") < 0) flag++;
