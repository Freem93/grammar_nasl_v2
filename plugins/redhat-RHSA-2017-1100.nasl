...
issue. Upstream acknowledges Ronald Crane as the original reporter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-1100.html"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"nss-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"nss-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-debuginfo-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"nss-debuginfo-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"nss-debuginfo-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-devel-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"nss-devel-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"nss-devel-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-pkcs11-devel-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"nss-pkcs11-devel-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"nss-pkcs11-devel-3.28.4-1.0.el7_3")) flag++;
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"nss-util-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"nss-util-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-util-debuginfo-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"nss-util-debuginfo-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"nss-util-debuginfo-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-util-devel-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"nss-util-devel-3.28.4-1.0.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"nss-util-devel-3.28.4-1.0.el7_3")) flag++;
