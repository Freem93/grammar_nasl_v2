...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ghostscript on SL4.x i386/x86_64");
...
which contain backported patches to correct these issues."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1202&L=scientific-linux-errata&T=0&P=908
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8bb0404"
  );
