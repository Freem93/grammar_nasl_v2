...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/10/22 10:42:23 $");
...
to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1310&L=scientific-linux-errata&T=0&P=1969
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad1f37d5"
  );
