...
if (description)
{
  ...
  script_osvdb_id(100031, 100032, 100033, 100034, 100035, 100036, 100037);
...
relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.drupal.org/drupal-7.24-release-notes");
  script_set_attribute(attribute:"solution", value:"Upgrade to version 7.24 or later.");
