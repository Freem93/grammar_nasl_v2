...
if (description)
{
  ...
  script_osvdb_id(142100, 145043, 145066, 145163, 145167, 145695, 145697, 146245, 147621, 147622, 147653, 147655, 147656, 147657, 148308);
...
were fixed :
  ...
  - CVE-2016-6351: The esp_do_dma function in hw/scsi/esp.c,
    ...
    (bsc#990843) This non-security issue was fixed :
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20163044-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6fa9694"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
