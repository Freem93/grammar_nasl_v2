...
# extracted from Ubuntu Security Notice USN-1328-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.10 : linux-mvl-dove vulnerabilities (USN-1328-1)");
...
system. (CVE-2011-4110)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected linux-image-2.6.32-422-dove package."
  );
  ...
  script_copyright(english:"Ubuntu Security Notice (C) 2012-2013 Canonical, Inc. / NASL script (C) 2012-2013 Tenable Network Security, Inc.");
...
if (ubuntu_check(osver:"10.10", pkgname:"linux-image-2.6.32-422-dove", pkgver:"2.6.32-422.40")) flag++;
