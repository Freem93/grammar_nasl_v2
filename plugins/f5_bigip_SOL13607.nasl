...
may not be cryptographically strong."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://eprint.iacr.org/2012/064.pdf"
  );
  # http://support.f5.com/kb/en-us/solutions/public/13000/600/sol13607.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d52a9675"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
