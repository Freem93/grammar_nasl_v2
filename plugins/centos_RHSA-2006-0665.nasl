...
a backported patch and is not vulnerable to this issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2006-September/013221.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e4fb119"
  );
  # http://lists.centos.org/pipermail/centos-announce/2006-September/013232.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?839347fc"
  );
  # http://lists.centos.org/pipermail/centos-announce/2006-September/013233.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?de5fc97b"
  );
  script_set_attribute(
    attribute:"solution", 
