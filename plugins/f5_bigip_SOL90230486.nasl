...
vmatrix["APM"]["affected"  ] = make_list("12.0.0-12.1.2","11.1.0-11.6.1");
vmatrix["APM"]["unaffected"] = make_list("13.0.0","11.0.0","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0-12.1.2","11.1.0-11.6.1");
vmatrix["ASM"]["unaffected"] = make_list("13.0.0","11.0.0","10.1.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0-12.1.2","11.1.0-11.6.1");
vmatrix["AVR"]["unaffected"] = make_list("13.0.0","11.0.0");
...
vmatrix["LC"]["affected"  ] = make_list("12.0.0-12.1.2","11.1.0-11.6.1");
vmatrix["LC"]["unaffected"] = make_list("13.0.0","11.0.0","10.1.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0-12.1.2","11.1.0-11.6.1");
vmatrix["LTM"]["unaffected"] = make_list("13.0.0","11.0.0","10.1.0-10.2.4");
