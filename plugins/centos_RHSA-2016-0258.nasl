...
changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2016-February/021706.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3a3f528a"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-February/021707.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?05176fd1"
  );
  # http://lists.centos.org/pipermail/centos-announce/2016-February/021708.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7086f728"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-38.6.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-38.6.0-1.el6.centos")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-38.6.0-1.el7.centos")) flag++;
