...
if (description)
{
  ...
  script_osvdb_id(40754, 40756, 40758, 40759, 40760, 40761, 40763, 40764, 40765, 40766);
...
and insecure version."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=464756"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2008/dsa-1570"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
