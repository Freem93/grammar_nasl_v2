...
# extracted from F5 Networks BIG-IP Solution SOL17241.
#
...
if (description)
{
  ...
  script_osvdb_id(116910);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (SOL17241)");
...
(CVE-2014-9585)"
  ...
  # http://support.f5.com/kb/en-us/solutions/public/17000/200/sol17241.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?89f9f413"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
