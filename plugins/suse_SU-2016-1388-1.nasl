...
if (description)
{
  ...
  script_osvdb_id(95414, 99529, 137300, 137301, 137302, 137303, 137304, 137307, 137308, 137755, 137756, 137759);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/977646"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/977648"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/977650"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/979252"
  );
  # https://download.suse.com/patch/finder/?keywords=133b4d37ec640a121ad2dbcba2704f70
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83856dc8"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-0264.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-0363.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-0376.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-3422.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-3443.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-3449.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161388-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2614b3bc"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected IBM Java 1.6.0 packages"
  );
