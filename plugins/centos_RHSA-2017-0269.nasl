...
cipher suite."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2017-February/022269.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4244020d"
  );
  # http://lists.centos.org/pipermail/centos-announce/2017-February/022270.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?29e54a2a"
  );
  # http://lists.centos.org/pipermail/centos-announce/2017-February/022271.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?11589ea0"
  );
  script_set_attribute(
    attribute:"solution", 
