...
if (description)
{
  ...
  script_cvs_date("$Date: 2014/06/04 10:49:57 $");
...
automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1406&L=scientific-linux-errata&T=0&P=426
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a5f8427c"
  );
  script_set_attribute(
    attribute:"solution", 
