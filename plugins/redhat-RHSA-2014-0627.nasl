...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : openssl (RHSA-2014:0627)");
...
rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2014-0627.html"
  );
...
if (sp == "2") {   if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"openssl-1.0.0-20.el6_2.7")) flag++; }
  ...
  if (rpm_check(release:"RHEL6", sp:"3", reference:"openssl-debuginfo-1.0.0-25.el6_3.3")) flag++;
