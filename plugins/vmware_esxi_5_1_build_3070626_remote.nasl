...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2016-B-0014");
...
memory, resulting in an elevation of privileges.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://kb.vmware.com/kb/2126488");
  script_set_attribute(attribute:"see_also", value:"http://kb.vmware.com/kb/2114860");
