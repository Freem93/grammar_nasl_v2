...
if (description)
{
  ...
  script_cvs_date("$Date: 2012/11/14 21:59:20 $");
...
bugs."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1211&L=scientific-linux-errata&T=0&P=817
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74889d23"
  );
