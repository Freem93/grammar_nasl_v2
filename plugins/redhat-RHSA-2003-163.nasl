...
other stability and security updates."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2002-1308.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.mozilla.org/releases/mozilla1.0.2/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2003-163.html"
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2002/11/14");
