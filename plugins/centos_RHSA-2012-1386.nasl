...
if (description)
{
  ...
  script_osvdb_id(86346, 86347, 86350, 86352, 86354, 86355, 86358, 86359, 86360, 86361, 86362, 86364, 86365, 86366, 86367, 86368, 86369, 86371, 86372, 86374);
  script_xref(name:"RHSA", value:"2012:1386");

  script_name(english:"CentOS 6 : java-1.7.0-openjdk (CESA-2012:1386)");
...
OpenJDK Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?be1cabba"
  );
  script_set_attribute(
    attribute:"solution", 
