...
changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2014-July/020430.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4c4176e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2014-July/020439.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f3dcd31"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-24.7.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-24.7.0-1.el6.centos")) flag++;
