...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 / 6 : jbossweb (RHSA-2013:0629)");
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2013-0629.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"jbossweb-2.1.13-3_patch_02.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossweb-el-1.0-api-2.1.13-3_patch_02.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossweb-jsp-2.1-api-2.1.13-3_patch_02.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossweb-lib-2.1.13-3_patch_02.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossweb-servlet-2.5-api-2.1.13-3_patch_02.ep5.el4")) flag++;
