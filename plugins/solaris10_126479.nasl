...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 126479-26");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"126479-26", obsoleted_by:"", package:"SUNWmessaging-server-64", version:"6.3,REV=2007.02.26") < 0) flag++;
