...
Red Hat would like to thank ISC for reporting these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-0562.html"
  );
...
os_ver = os_ver[1];
if (! ereg(pattern:"^(6\.4|6\.5|6\.6)([^0-9]|$)", string:os_ver)) audit(AUDIT_OS_NOT, "Red Hat 6.4 / 6.5 / 6.6", "Red Hat " + os_ver);
