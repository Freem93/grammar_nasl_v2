...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssl097a and openssl098e on SL5.x, SL6.x i386/x86_64");
...
restarted or the system rebooted."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1406&L=scientific-linux-errata&T=0&P=800
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?080e1d4c"
  );
