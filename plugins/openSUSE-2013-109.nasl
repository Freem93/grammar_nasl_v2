...
if (description)
{
  ...
  script_osvdb_id(85110, 88101, 88656, 88657, 89614, 89615, 89616, 89848);
...
Also check out http://www.opera.com/docs/changelogs/unix/1213"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2013-02/msg00025.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2013-02/msg00088.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.opera.com/docs/changelogs/unix/1213"
  );
  script_set_attribute(
    attribute:"see_also",
