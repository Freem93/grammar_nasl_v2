...
which contains backported patches that resolve these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2005-August/011999.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?698d478d"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-August/012000.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d8546ef5"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-August/012001.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2a51e225"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-August/012004.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f327bc3e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-August/012031.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e61e4915"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-August/012032.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?397a5d39"
  );
  script_set_attribute(
    attribute:"solution", 
