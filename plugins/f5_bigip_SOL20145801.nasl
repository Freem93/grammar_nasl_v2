...
vmatrix["LC"]["unaffected"] = make_list("12.1.2","11.6.1HF1");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0-12.1.1","11.0.0-11.6.1","10.1.0-10.2.4");
vmatrix["LTM"]["unaffected"] = make_list("12.1.2","11.6.1HF1");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("12.0.0-12.1.1","11.3.0-11.6.1");
vmatrix["PEM"]["unaffected"] = make_list("12.1.2","11.6.1HF1");
