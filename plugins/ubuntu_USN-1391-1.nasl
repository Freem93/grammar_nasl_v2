...
# extracted from Ubuntu Security Notice USN-1391-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(51380);
  script_xref(name:"USN", value:"1391-1");

  script_name(english:"Ubuntu 10.10 : linux-mvl-dove vulnerability (USN-1391-1)");
...
on the system."
  ...
  script_copyright(english:"Ubuntu Security Notice (C) 2012-2013 Canonical, Inc. / NASL script (C) 2012-2014 Tenable Network Security, Inc.");
