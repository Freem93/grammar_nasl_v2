...
if (description)
{
  ...
  script_osvdb_id(144952, 144999, 145250, 145251, 145549);
...
arbitrary code in the context of the gs process. (CVE-2016-8602)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-7978.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-0013.html"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"ghostscript-9.07-20.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"ghostscript-9.07-20.el7_3.1")) flag++;
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"ghostscript-debuginfo-9.07-20.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"ghostscript-debuginfo-9.07-20.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"ghostscript-devel-9.07-20.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"ghostscript-devel-9.07-20.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"ghostscript-devel-9.07-20.el7_3.1")) flag++;
