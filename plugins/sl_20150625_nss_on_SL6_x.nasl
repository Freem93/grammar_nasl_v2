...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss on SL6.x, SL7.x i386/x86_64 (Logjam)");
...
enhancements over the previous versions."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1506&L=scientific-linux-errata&F=&S=&P=14561
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9f162d1"
  );
