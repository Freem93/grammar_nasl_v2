...
if (description)
{
  ...
  script_osvdb_id(120327, 130089, 130090);
...
kernel before 4.2.4 does not properly handle rename actions inside a
bind mount, which allows local users to bypass an intended container
protection mechanism by renaming a directory, related to a
...
vmatrix["AFM"]["unaffected"] = make_list("12.1.0","12.0.0HF3");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("12.0.0","11.4.0-11.6.0");
vmatrix["AM"]["unaffected"] = make_list("12.1.0","12.0.0HF3");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("12.0.0","11.1.0-11.6.0");
vmatrix["APM"]["unaffected"] = make_list("12.1.0","12.0.0HF3","11.0.0","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0","11.1.0-11.6.0");
vmatrix["ASM"]["unaffected"] = make_list("12.1.0","12.0.0HF3","11.0.0","10.1.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0","11.1.0-11.6.0");
vmatrix["AVR"]["unaffected"] = make_list("12.1.0","12.0.0HF3","11.0.0");
...
vmatrix["LC"]["unaffected"] = make_list("12.1.0","12.0.0HF3","11.0.0","10.1.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0","11.1.0-11.6.0");
vmatrix["LTM"]["unaffected"] = make_list("12.1.0","12.0.0HF3","11.0.0","10.1.0-10.2.4");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("12.0.0","11.3.0-11.6.0");
vmatrix["PEM"]["unaffected"] = make_list("12.1.0","12.0.0HF3");
