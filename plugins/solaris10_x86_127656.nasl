...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 127656-07");
  script_summary(english:"Check for patch 127656-07");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 127656-07");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"127656-07", obsoleted_by:"", package:"SYMCnetbp", version:"6.5,REV=2007.07.24.03.39") < 0) flag++;
