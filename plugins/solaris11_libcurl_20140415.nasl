...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f93e0c9"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/entry/cve_2013_2174_buffer_errors"
  );
  # https://blogs.oracle.com/sunsecurity/entry/cve_2013_4545_cryptographic_issues
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b3db4eb"
  );
  # https://blogs.oracle.com/sunsecurity/entry/cve_2014_0015_authentication_issues
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6c3917fa"
  );
