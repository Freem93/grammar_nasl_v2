...
changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2013-September/019942.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3563c704"
  );
  # http://lists.centos.org/pipermail/centos-announce/2013-September/019944.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6d913727"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-17.0.9-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-17.0.9-1.el6.centos")) flag++;
