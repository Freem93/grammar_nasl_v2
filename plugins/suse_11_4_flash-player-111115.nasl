...
if (description)
{
  ...
  script_osvdb_id(77018, 77019, 77020, 77021, 77022, 77023, 77024, 77025, 77026, 77027, 77028, 77029);
...
CVE-2011-2457, CVE-2011-2458, CVE-2011-2459, CVE-2011-2460"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2011-11/msg00020.html"
  );
  script_set_attribute(
    attribute:"see_also",
