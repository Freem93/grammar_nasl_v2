...
if (description)
{
  ...
  script_osvdb_id(89613, 89758, 89759, 89760, 89761, 89762, 89763, 89767, 89769, 89771, 89772, 89785, 89786, 89792, 89795, 89796, 89798, 89800, 89801, 89802, 89804, 89806);
...
OpenJDK Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-February/003248.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-February/003251.html"
  );
  script_set_attribute(
    attribute:"solution", 
