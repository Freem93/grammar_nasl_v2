...
# Notice USN-1691-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2012-4530");
  ...
  script_name(english:"USN-1691-1 : linux-ti-omap4 vulnerability");
...
exploit this flaw to cause a leak of kernel stack contents.");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1691-1/");
...
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-1220-omap4", pkgver:"3.0.0-1220.33")) flag++;
