...
if (description)
{
  ...
  script_osvdb_id(10026, 10027, 10028, 10029, 10030, 10031, 10032, 10033, 10034, 11598, 11599, 11988, 11989, 11990, 11991);
...
library."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2004-537.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
