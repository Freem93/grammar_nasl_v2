...
- Rebuild with the updated docker-engine"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-May/006086.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-May/006087.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected docker-engine packages."
  );
...
flag = 0;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"docker-engine-1.10.3-1.0.3.el6")) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"docker-engine-1.10.3-1.0.3.el7")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"docker-engine-selinux-1.10.3-1.0.3.el7")) flag++;
