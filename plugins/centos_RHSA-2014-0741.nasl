...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4e115bf"
  );
  # http://lists.centos.org/pipermail/centos-announce/2014-June/020365.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b26413cf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-24.6.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-24.6.0-1.el6.centos")) flag++;
