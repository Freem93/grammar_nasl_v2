...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ocaml on SL6.x i386/x86_64");
...
"Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1704&L=scientific-linux-errata&F=&S=&P=797
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e2a1bb96"
  );
