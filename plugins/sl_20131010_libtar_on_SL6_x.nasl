...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/10/20 23:36:55 $");

  script_cve_id("CVE-2013-4397");

  script_name(english:"Scientific Linux Security Update : libtar on SL6.x i386/x86_64");
...
Note: This issue only affected 32-bit builds of libtar."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1310&L=scientific-linux-errata&T=0&P=558
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5bee21fb"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
