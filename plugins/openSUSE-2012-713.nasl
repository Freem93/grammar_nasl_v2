...
user could be tricked into a prepared file."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-10/msg00058.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"mcrypt-2.6.8-19.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mcrypt-debuginfo-2.6.8-19.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mcrypt-debugsource-2.6.8-19.1") ) flag++;
