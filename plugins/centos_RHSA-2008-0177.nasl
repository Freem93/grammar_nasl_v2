...
finding and reporting this issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-March/014742.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b0490e91"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-March/014748.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1ef3f991"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-March/014749.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f48b106"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-March/014750.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f5784abb"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-March/014751.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?862c13bf"
  );
  script_set_attribute(
    attribute:"solution", 
