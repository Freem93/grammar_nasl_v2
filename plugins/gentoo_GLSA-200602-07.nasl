...
if (description)
{
  ...
  script_osvdb_id(23091, 23092, 23093, 23094, 23095, 23096, 23097);
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://sunsolve.sun.com/search/document.do?assetkey=1-26-102170-1"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://sunsolve.sun.com/search/document.do?assetkey=1-26-102171-1"
  );
  script_set_attribute(
    attribute:"see_also",
