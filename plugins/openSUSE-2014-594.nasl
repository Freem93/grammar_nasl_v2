...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2014-594 patch");
...
"  - Replace patches bash-4.2-heredoc-eof-delim.patch and
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2014-10/msg00023.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=896776"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=898346"
  );
