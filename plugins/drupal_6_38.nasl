...
6.38. It is, therefore, affected by the following vulnerabilities :
  ...
  - A flaw exists in the drupal_set_header() function due to
    ...
    arbitrary headers. (VulnDB 135018)
