...
if (description)
{
  ...
  script_osvdb_id(116750, 116751, 118453, 118454, 118458, 123202, 123274);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-4468.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160011-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8e45dd06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
