...
if (description)
{
  ...
  script_osvdb_id(116071, 116072, 120524, 123974, 126663, 126664, 126665, 126666, 129298, 129299, 129302, 129304, 129307, 129309, 129311, 129315);
...
daemon and utility programs :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2015/dsa-3388"
  );
  script_set_attribute(
    attribute:"see_also",
