...
if (description)
{
  ...
  script_cvs_date("$Date: 2012/12/16 03:33:05 $");
...
automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1210&L=scientific-linux-errata&T=0&P=1765
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?24d38856"
  );
