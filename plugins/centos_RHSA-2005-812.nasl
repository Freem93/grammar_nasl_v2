...
if (description)
{
  ...
  script_osvdb_id(2005, 20011, 20012);
...
which contain a backported patch that resolves this issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2005-November/012351.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?896b962d"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-November/012356.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?31fffb10"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-November/012366.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?91a38dd3"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-November/012367.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6d0fbfe3"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-November/012369.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e17f49de"
  );
  # http://lists.centos.org/pipermail/centos-announce/2005-November/012372.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6415a082"
  );
