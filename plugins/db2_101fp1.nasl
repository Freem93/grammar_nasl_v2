...
if (description)
{
  ...
  script_osvdb_id(84045, 84046, 84047, 85787);
...
remote host is affected by one or more of the following issues :
  ...
  # IC84716
  script_set_attribute(attribute:"see_also", value:"http://www.ibm.com/support/docview.wss?uid=swg1IC84716");
  # IC84751
  script_set_attribute(attribute:"see_also", value:"http://www.ibm.com/support/docview.wss?uid=swg1IC84751");
  # IC84755
  script_set_attribute(attribute:"see_also", value:"http://www.ibm.com/support/docview.wss?uid=swg1IC84755");
  # IC85513
  script_set_attribute(attribute:"see_also", value:"http://www.ibm.com/support/docview.wss?uid=swg1IC85513");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg24033451");
  script_set_attribute(attribute:"solution", value:"Apply IBM DB2 version 10.1 Fix Pack 1 or later.");
