...
if (description)
{
  ...
  script_osvdb_id(95714, 97216, 97218, 97219, 97220, 97221, 97222);
...
following dissectors :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.wireshark.org/docs/relnotes/wireshark-1.8.10.html");
...
foreach install(keys(installs))
{
  ...
  if (version =~ "^1\.8\.[0-9]($|[^0-9])")
    info +=
      '\n  Path              : ' + installs[install] +
      '\n  Installed version : ' + version +
      '\n  Fixed version     : 1.8.10\n';
  else
