...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 / 6 : JBoss EAP (RHSA-2015:2535)");
...
update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-2535.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
else
{
  ...
  if (rpm_check(release:"RHEL4", reference:"jakarta-commons-collections-3.2.1-5.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jakarta-commons-collections-tomcat5-3.2.1-5.ep5.el4")) flag++;
