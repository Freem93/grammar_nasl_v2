...
erratum package also contains some minor bug fixes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2004-0536.html"
  );
  # http://marc.theaimsgroup.com/?l=bugtraq&m=108627481507249
  script_set_attribute(
    attribute:"see_also",
    value:"http://marc.info/?l=bugtraq&m=108627481507249"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2004-244.html"
  );
  script_set_attribute(
    attribute:"solution", 
