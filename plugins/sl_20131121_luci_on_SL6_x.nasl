...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : luci on SL6.x i386/x86_64");
...
automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=1429
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7e5ddc01"
  );
  script_set_attribute(
    attribute:"solution", 
