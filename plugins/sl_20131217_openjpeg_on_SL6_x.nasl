...
if (description)
{
  ...
  script_cvs_date("$Date: 2013/12/18 14:34:31 $");
...
update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=5174
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bc1441f3"
  );
