...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/952849"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/964465"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-5313.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160923-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?110851df"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
