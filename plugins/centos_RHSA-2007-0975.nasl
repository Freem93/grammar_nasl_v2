...
contains a backported patch that resolves this issue."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014331.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?253e1303"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014340.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3aa2d0c4"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014341.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ee61766"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014346.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5a5a6032"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014347.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca80b20d"
  );
