...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.8.0-openjdk on SL7.x x86_64 (SLOTH)");
...
to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1601&L=scientific-linux-errata&F=&S=&P=10638
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c6809cdd"
  );
