...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : cvs on SL5.x, SL6.x i386/x86_64");
...
which contain a patch to correct this issue."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1203&L=scientific-linux-errata&T=0&P=306
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6f52edcc"
  );
  script_set_attribute(
    attribute:"solution", 
