...
if (description)
{
  ...
  script_bugtraq_id(58504, 58507, 59131, 59141, 59153, 59159, 59162, 59165, 59166, 59167, 59170, 59179, 59184, 59187, 59190, 59194, 59206, 59212, 59213, 59228, 59243);
  script_osvdb_id(91206, 91472, 92335, 92336, 92337, 92339, 92342, 92343, 92344, 92346, 92347, 92348, 92358, 92359, 92360, 92361, 92362, 92363, 92364, 92365, 92366);

  script_name(english:"openSUSE Security Update : java-1_7_0-openjdk (openSUSE-SU-2013:0745-1)");
  script_summary(english:"Check for the openSUSE-2013-402 patch");
...
"  - apply aarch64 patches on openSUSE 12.3+, EM_AARCH64 is
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2013-05/msg00010.html"
  );
  script_set_attribute(
    attribute:"see_also",
