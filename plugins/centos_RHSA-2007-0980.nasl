...
which contain backported patches that correct these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014305.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?81846abe"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014311.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?001db98e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014312.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74b4f473"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014318.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8dd99ec4"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014322.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5a2a102e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-October/014323.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?14b6f597"
  );
  script_set_attribute(
    attribute:"solution", 
