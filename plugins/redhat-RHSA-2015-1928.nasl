...
if (description)
{
  ...
  script_osvdb_id(129119, 129120, 129121, 129122, 129123, 129124, 129125, 129129, 129131, 129133, 129134, 129135, 129136, 129137, 129138, 129139, 129140);
...
update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-1928.html"
  );
