...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://docs.moodle.org/dev/Moodle_2.2.10_release_notes"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://docs.moodle.org/dev/Moodle_2.3.7_release_notes"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://docs.moodle.org/dev/Moodle_2.4.4_release_notes"
  );
  script_set_attribute(
    attribute:"see_also",
