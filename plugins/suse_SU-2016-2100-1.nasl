...
if (description)
{
  ...
  script_osvdb_id(136473, 136948, 136949, 137159, 137352, 137353, 138374, 138741, 138742, 138951, 138952, 139049, 139050, 139051, 139178, 139179, 139237, 139321, 139322, 139324, 139518, 139575, 139576, 142100, 142140, 142178);
...
were fixed :
  ...
  - bsc#967630: Discrepancy in reported memory size with
    correction XSA-153 for xend. Additional memory
    adjustment made.

  - bsc#974912: Persistent performance drop after
    live-migration using xend tool stack

  - bsc#979035: Restore xm migrate fixes for bsc#955399/
    bsc#955399

  - bsc#989235: xen dom0 xm create command only searched
    /etc/xen instead of /etc/xen/vm

  - Live Migration SLES 11 SP3 to SP4 on AMD: 'xc: error:
    Couldn't set extended vcpu0 info'
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/974912"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/989235"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162100-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f07066e7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
