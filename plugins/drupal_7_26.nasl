...
relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.drupal.org/drupal-7.26-release-notes");
  script_set_attribute(attribute:"solution", value:"Upgrade to version 7.26 or later.");
