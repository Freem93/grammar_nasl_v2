...
to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2012-February/018406.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a291ca65"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-3.1.18-1.el6.centos")) flag++;
