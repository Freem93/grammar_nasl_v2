...
if (description)
{
  ...
  script_name(english:"Slackware 8.1 / current : Samba buffer overflow fixed");
...
fix a security problem. All sites running samba should upgrade."
  );
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2003&m=slackware-security.267044
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b803a37f"
  );
...
flag = 0;
if (slackware_check(osver:"8.1", pkgname:"samba", pkgver:"2.2.8", pkgarch:"i386", pkgnum:"1")) flag++;

if (slackware_check(osver:"current", pkgname:"samba", pkgver:"2.2.8", pkgarch:"i386", pkgnum:"1")) flag++;
