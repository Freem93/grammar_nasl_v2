...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 116271-10");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"116271-10", obsoleted_by:"", package:"VRTSnetbp", version:"5.1,REV=2004.05.11.17.55") < 0) flag++;
