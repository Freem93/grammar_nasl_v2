...
if (description)
{
  ...
  script_osvdb_id(72936);
  script_xref(name:"MSFT", value:"MS11-048");
  script_xref(name:"IAVA", value:"2011-A-0078");
...
host to stop responding until manually restarted."
  ...
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms11-048");
  script_set_attribute(
    attribute:"solution",
    value:
