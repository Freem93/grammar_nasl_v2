...
# Notice USN-1260-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2011-2494");
  ...
  script_name(english:"USN-1260-1 : linux-ti-omap4 vulnerability");
...
information, leading to a loss of privacy.");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1260-1/");
...
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-1206-omap4", pkgver:"3.0.0-1206.12")) flag++;
