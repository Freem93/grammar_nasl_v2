...
contain backported patches that correct these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-December/015503.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1545308b"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-December/015504.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?31d8e182"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-December/015506.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6c781b33"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-December/015507.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6416324"
  );
  script_set_attribute(
    attribute:"solution", 
