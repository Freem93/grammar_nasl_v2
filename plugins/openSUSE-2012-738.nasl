...
if (description)
{
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-10/msg00083.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"exim-4.80.1-23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"exim-debuginfo-4.80.1-23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"exim-debugsource-4.80.1-23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"eximon-4.80.1-23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"eximon-debuginfo-4.80.1-23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"eximstats-html-4.80.1-23.1") ) flag++;
