...
# extracted from F5 Networks BIG-IP Solution SOL16090.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIG-IP Automatic Update Check and ASM Automatic Signature Update man-in-the-middle vulnerability (SOL16090)");
...
functionality is susceptible to Man-in-the-Middle type attacks due to
improper validation of server SSL certificates."
  );
  # http://support.f5.com/kb/en-us/solutions/public/16000/000/sol16090.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ac0705e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
