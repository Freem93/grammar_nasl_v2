...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : rpcbind on SL6.x i386/x86_64");
...
"Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1705&L=scientific-linux-errata&F=&S=&P=6901
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a52af2cf"
  );
  script_set_attribute(
    attribute:"solution", 
