...
if (description)
{
  ...
  script_cvs_date("$Date: 2015/03/30 17:01:35 $");
...
certs = make_array(
  '4822824ECE7ED1450C039AA077DC1F8AE3489BBF','CCA India 2007',
  'C6796490CDEEAAB31AED798752ECD003E6866CB2','CCA India 2011',
  'D2DBF71823B2B8E78F5958096150BFCB97CC388A','CCA India 2014'
);
...
if (!isnull(data) && data != '')
{
  ...
  # 01cf9702275f5296 (Thu, 03 July 2014 21:02:52 UTC)
  # Effective Date for KB2677070
  fixed_time = raw_string(0x01, 0xcf, 0x97, 0x02, 0x27, 0x5f, 0x52, 0x96);
