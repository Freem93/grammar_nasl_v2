...
containing FreeRADIUS 0.9.3 which is not vulnerable to these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2003-0967.html"
  );
  # http://marc.theaimsgroup.com/?l=freeradius-users&m=106947389449613
  script_set_attribute(
    attribute:"see_also",
    value:"http://marc.info/?l=freeradius-users&m=106947389449613"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2003-386.html"
  );
  script_set_attribute(
    attribute:"solution", 
