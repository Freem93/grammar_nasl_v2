...
Chen, and Nathan Froyd as the original reporters."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2017-March/022326.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e8e0dfb5"
  );
  # http://lists.centos.org/pipermail/centos-announce/2017-March/022327.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1f9f8720"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-45.8.0-2.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-45.8.0-2.el6.centos")) flag++;
