...
if (description)
{
  ...
  script_osvdb_id(89848, 89865, 93745);
...
relied only on the application's self-reported version number."
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.splunk.com/view/SP-CAAAHXG");
  script_set_attribute(attribute:"see_also", value:"http://docs.splunk.com/Documentation/Splunk/latest/ReleaseNotes/5.0.3");
  script_set_attribute(attribute:"solution", value:"Upgrade to Splunk 5.0.3 or later.");
