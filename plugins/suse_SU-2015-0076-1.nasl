...
if (description)
{
  ...
  script_osvdb_id(115397, 116993, 116994, 116995, 116996, 116997, 116998, 116999, 117000, 117001, 117002, 117003, 117004, 117007);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2014-8635.html"
  );
  script_set_attribute(
    attribute:"see_also",
