...
which contain a backported patch that corrects this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d10cc868"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-August/016112.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ab500f33"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-August/016115.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f96e7092"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-August/016116.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?308bb4ff"
  );
  script_set_attribute(
    attribute:"solution", 
