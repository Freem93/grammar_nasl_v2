...
if (description)
{
  ...
  script_bugtraq_id(74733, 75154, 75156, 75157, 75158, 75159, 75161);
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201506-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/openssl", unaffected:make_list("ge 1.0.1o", "ge 0.9.8z_p7"), vulnerable:make_list("lt 1.0.1o"))) flag++;
