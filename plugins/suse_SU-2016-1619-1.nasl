...
These non-security issues were fixed :
  ...
  - bsc#960961: Use 'plugin-load-add' instead of
    'plugin-load' in default_plugins.cnf. It contained
    'plugin-load' options which caused that only last plugin
    was actually loaded ('plugin-load' overrides the
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161619-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4e222841"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
