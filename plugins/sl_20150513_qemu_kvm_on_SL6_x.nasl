...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : qemu-kvm on SL6.x i386/x86_64 (Venom)");
...
update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1505&L=scientific-linux-errata&T=0&P=1609
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76db9206"
  );
