...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libexif on SL5.x, SL6.x i386/x86_64");
...
to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1209&L=scientific-linux-errata&T=0&P=1374
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2d53915b"
  );
  script_set_attribute(
    attribute:"solution", 
