...
if (description)
{
  ...
  script_cvs_date("$Date: 2017/03/21 15:35:26 $");
  ...
  script_osvdb_id(115343, 115344, 146392, 148129, 148375, 148394, 148798, 149021, 149100, 150692, 151241, 152349);
...
fixed :
  ...
  - CVE-2016-10024: Xen allowed local x86 PV guest OS kernel
    ...
    operations (bsc#1014298) This non-security issue was
    fixed :
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170718-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2e84d97f"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
