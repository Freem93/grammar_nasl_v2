...
fixed :
  ...
  - CVE-2016-7909: The pcnet_rdra_addr function in
    ...
    transmit descriptor ring length to 0 (bsc#1003032) These
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20163156-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?31cafaf1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
