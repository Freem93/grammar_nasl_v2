...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-0071.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-38.6.0-1.el5_11")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-38.6.0-1.el5_11")) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-38.6.0-1.el6_7")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-38.6.0-1.el6_7")) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-38.6.0-1.el7_2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-38.6.0-1.el7_2")) flag++;
