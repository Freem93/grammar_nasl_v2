...
if (description)
{
  ...
  script_osvdb_id(57806);
  script_xref(name:"IAVA", value:"2009-A-0078");
...
system.");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS09-049");
