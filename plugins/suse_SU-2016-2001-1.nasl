...
if (description)
{
  ...
  script_osvdb_id(130525, 133550, 134938, 135678, 138176, 138431, 140046);
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162001-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d0654098"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
