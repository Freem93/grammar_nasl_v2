...
remote host."
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.adobe.com/products/dreamweaver.html");
...
key = "SOFTWARE\Adobe\Dreamweaver";
...
{
  close_registry();
  audit(AUDIT_NOT_INST, 'Adobe Dreamweaver');
}
else
{
...
if (report)
{
  ...
  {
    if (installs > 1) s = 's of Adobe Dreamweaver were found ';
    else s = ' of Adobe Dreamweaver was found ';
    report =
...
else audit(AUDIT_UNINST, 'Adobe Dreamweaver');
