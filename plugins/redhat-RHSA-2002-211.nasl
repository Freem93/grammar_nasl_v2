...
errata packages which contain patches to correct the vulnerability."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2002-0838.html"
  );
  # http://marc.theaimsgroup.com/?l=bugtraq&m=103305778615625&w=2
  script_set_attribute(
    attribute:"see_also",
    value:"http://marc.info/?l=bugtraq&m=103305778615625&w=2"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2002-211.html"
  );
