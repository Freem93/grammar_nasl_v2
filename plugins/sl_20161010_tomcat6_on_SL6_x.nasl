...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tomcat6 on SL6.x (noarch) (httpoxy)");
...
Bug Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1610&L=scientific-linux-errata&F=&S=&P=1313
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?71fae878"
  );
