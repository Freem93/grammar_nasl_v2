...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 150619-02");
  script_summary(english:"Check for patch 150619-02");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 150619-02"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"150619-02", obsoleted_by:"", package:"SUNWocmr", version:"11.11,REV=2012.12.04.14.32") < 0) flag++;
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"150619-02", obsoleted_by:"", package:"SUNWocmu", version:"11.11,REV=2012.11.13.16.42") < 0) flag++;
