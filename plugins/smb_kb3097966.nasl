...
if (description)
{
  ...
  script_cvs_date("$Date: 2017/02/17 21:51:17 $");
...
Cryptography API is being actively used on the remote host.");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/en-us/library/security/3097966");
  ...
  # https://support.microsoft.com/en-us/help/3097966/microsoft-security-advisory-inadvertently-disclosed-digital-certificates-could-allow-spoofing-october-13,-2015
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f636748");
