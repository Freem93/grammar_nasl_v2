...
if (description)
{
  ...
  script_osvdb_id(148296, 148297, 148298, 148299);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1003577"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1003579"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1003580"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1013882"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170004-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3ba3acba"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
