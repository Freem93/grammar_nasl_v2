...
The system must be rebooted for this update to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2009-April/015804.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5a8cada4"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-April/015805.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d8189849"
  );
  script_set_attribute(
    attribute:"solution", 
