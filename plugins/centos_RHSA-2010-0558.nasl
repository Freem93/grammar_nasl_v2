...
the update, Firefox must be restarted for the changes to take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2010-August/016880.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?845b2444"
  );
  # http://lists.centos.org/pipermail/centos-announce/2010-August/016881.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?67b9ef4c"
  );
  script_set_attribute(
    attribute:"solution", 
