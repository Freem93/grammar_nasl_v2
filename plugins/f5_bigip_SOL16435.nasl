...
if (description)
{
  ...
  script_osvdb_id(110668, 110669, 110670, 110671, 110672, 110673, 110675);
...
IBM1364 encoded data to UTF-8."
  ...
  # http://support.f5.com/kb/en-us/solutions/public/16000/400/sol16435.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c1c3c86a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
