...
if (description)
{
  ...
  script_osvdb_id(54952, 54953, 54954, 54955, 54956, 54957, 54958);
...
privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS09-021");
  script_set_attribute(attribute:"see_also", value:"http://www.zerodayinitiative.com/advisories/ZDI-09-040/");
  script_set_attribute(
    attribute:"solution",
    value:
