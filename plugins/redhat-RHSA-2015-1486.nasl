...
if (description)
{
  ...
  script_bugtraq_id(74733, 75784, 75812, 75818, 75823, 75832, 75833, 75854, 75857, 75861, 75867, 75874, 75883, 75890, 75895, 75985);
...
instances of IBM Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2015-1486.html"
  );
