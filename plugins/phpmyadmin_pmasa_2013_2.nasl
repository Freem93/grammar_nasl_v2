...
if (description)
{
  ...
  script_cvs_date("$Date: 2014/06/26 18:35:01 $");
  ...
  script_bugtraq_id(59460, 59461, 59462, 59465);
  script_osvdb_id(92792, 92793, 92794, 92795);
...
4.0.0-rc3 and is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.phpmyadmin.net/home_page/security/PMASA-2013-2.php");
  script_set_attribute(attribute:"see_also", value:"http://www.phpmyadmin.net/home_page/security/PMASA-2013-3.php");
  script_set_attribute(attribute:"see_also", value:"http://www.phpmyadmin.net/home_page/security/PMASA-2013-4.php");
  script_set_attribute(attribute:"see_also", value:"http://www.phpmyadmin.net/home_page/security/PMASA-2013-5.php");
