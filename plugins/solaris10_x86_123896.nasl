...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 123896-81");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"123896-81", obsoleted_by:"", package:"SUNWcacaort", version:"2.0,REV=15") < 0) flag++;
