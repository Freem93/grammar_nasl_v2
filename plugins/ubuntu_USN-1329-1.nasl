...
# Notice USN-1329-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2011-3353");
  ...
  script_name(english:"USN-1329-1 : linux-ti-omap4 vulnerability");
...
service.");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1329-1/");
