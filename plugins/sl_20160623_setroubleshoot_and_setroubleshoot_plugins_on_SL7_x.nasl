...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : setroubleshoot and setroubleshoot-plugins on SL7.x x86_64");
...
execute arbitrary code with root privileges."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1606&L=scientific-linux-errata&F=&S=&P=7157
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad0a8be1"
  );
