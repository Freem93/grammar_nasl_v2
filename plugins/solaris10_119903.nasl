...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 119903-02");
  script_summary(english:"Check for patch 119903-02");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 119903-02"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119903-02", obsoleted_by:"", package:"SUNWolrte", version:"3.7.3,REV=1.2004.06.28") < 0) flag++;
