...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2014-1144.html"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-24.8.0-2.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-24.8.0-2.el5_10")) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-24.8.0-1.el6_5")) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-24.8.0-1.el6_5")) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-24.8.0-1.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-24.8.0-1.el7_0")) flag++;
