...
Flash ActiveX control, which could lead to code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"http://support.microsoft.com/kb/2857645");
  script_set_attribute(attribute:"solution", value:"Install Microsoft KB2857645.");
