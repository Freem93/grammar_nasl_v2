...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/992534"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-5384.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162190-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?94b0d6bd"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
