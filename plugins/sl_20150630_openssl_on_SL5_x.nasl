...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssl on SL5.x i386/x86_64 (Logjam)");
...
library must be restarted, or the system rebooted."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1506&L=scientific-linux-errata&F=&S=&P=15584
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?042a50d1"
  );
