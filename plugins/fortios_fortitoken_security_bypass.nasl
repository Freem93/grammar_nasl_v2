...
authenticate even when a token is locked.");
  # http://kb.fortinet.com/kb/microsites/search.do?cmd=displayKC&docType=kc&externalId=FortiOS-v50-Patch-Release-5-Release-Notespdf
  script_set_attribute(attribute:"see_also",value:"http://www.nessus.org/u?1edb5b6b");
