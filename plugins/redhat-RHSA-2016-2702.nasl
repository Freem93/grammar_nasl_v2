...
sandbox. (CVE-2016-7545)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-2702.html"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"policycoreutils-debuginfo-2.5-9.el7")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"policycoreutils-debuginfo-2.5-9.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"policycoreutils-devel-2.5-9.el7")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"policycoreutils-devel-2.5-9.el7")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"policycoreutils-devel-2.5-9.el7")) flag++;
