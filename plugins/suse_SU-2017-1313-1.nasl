...
if (description)
{
  ...
  script_osvdb_id(126901, 144562, 151459, 155161);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1005591"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1035905"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/934119"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/952474"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-7995.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-9019.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-4738.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2017-5029.html"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20171313-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4c3e1898"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
