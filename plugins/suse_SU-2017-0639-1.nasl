...
if (description)
{
  ...
  script_osvdb_id(106958, 128864, 128865, 148221);
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1013992"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1013993"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/950110"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/950111"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2014-9913.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-7696.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-7697.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-9844.html"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170639-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5564b937"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
