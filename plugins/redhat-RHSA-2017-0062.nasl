...
Red Hat would like to thank ISC for reporting these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-9131.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-9444.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://kb.isc.org/article/AA-01439"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://kb.isc.org/article/AA-01441"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-0062.html"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"bind-debuginfo-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"bind-debuginfo-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-devel-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"bind-devel-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"bind-devel-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-libs-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"bind-libs-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"bind-libs-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-libs-lite-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"bind-libs-lite-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"bind-libs-lite-9.9.4-38.el7_3.1")) flag++;
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"bind-lite-devel-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"bind-lite-devel-9.9.4-38.el7_3.1")) flag++;
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"bind-pkcs11-devel-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"bind-pkcs11-devel-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-pkcs11-libs-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"bind-pkcs11-libs-9.9.4-38.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"bind-pkcs11-libs-9.9.4-38.el7_3.1")) flag++;
