...
if (description)
{
  ...
  script_osvdb_id(66003, 68551, 68552);
...
that is affected by the following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://seclists.org/fulldisclosure/2010/Jul/3");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS10-073");
  script_set_attribute(
    attribute:"solution",
    value:
