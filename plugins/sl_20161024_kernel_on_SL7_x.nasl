...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kernel on SL7.x x86_64 (Dirty COW)");
...
"Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1610&L=scientific-linux-errata&F=&S=&P=6057
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?46f8bca2"
  );
