...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/899486"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/976920"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2014-7204.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162097-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e259b86a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
