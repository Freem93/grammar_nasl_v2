...
effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2009-October/016266.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83147c7e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-October/016267.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c54c9e5e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-October/016292.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0f4ac23b"
  );
  # http://lists.centos.org/pipermail/centos-announce/2009-October/016293.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c2f62a61"
  );
  script_set_attribute(
    attribute:"solution", 
