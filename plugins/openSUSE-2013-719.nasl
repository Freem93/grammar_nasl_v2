...
if (description)
{
  ...
  script_osvdb_id(97387, 97388, 97389, 97390, 97391, 97392, 97395, 97398, 97399, 97400, 97401, 97402, 97403, 97404);
...
and non-security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2013-09/msg00059.html"
  );
  script_set_attribute(
    attribute:"see_also",
