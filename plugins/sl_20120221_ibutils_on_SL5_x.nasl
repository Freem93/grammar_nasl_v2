...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ibutils on SL5.x i386/x86_64");
...
which contain backported patches to correct these issues."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1203&L=scientific-linux-errata&T=0&P=3670
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b49770e9"
  );
