...
packages, which contain backported patches that correct these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-November/015371.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6567eb7c"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-November/015372.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?04cdee7f"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-November/015383.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ba42d958"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-November/015384.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e9f19348"
  );
  script_set_attribute(
    attribute:"solution", 
