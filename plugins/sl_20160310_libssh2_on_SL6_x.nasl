...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libssh2 on SL6.x, SL7.x i386/x86_64");
...
using libssh2 must be restarted for this update to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1603&L=scientific-linux-errata&F=&S=&P=4184
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0ac2320d"
  );
