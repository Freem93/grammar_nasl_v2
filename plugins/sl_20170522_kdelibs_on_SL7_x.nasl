...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kdelibs on SL7.x x86_64");
...
"Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1705&L=scientific-linux-errata&F=&S=&P=6240
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?30a2988b"
  );
