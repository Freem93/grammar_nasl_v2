...
if (description)
{
  ...
  script_osvdb_id(105525, 105526, 105527, 105528, 105529, 105530);
...
on the remote host.");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms14-018");
  script_set_attribute(attribute:"see_also", value:"http://zerodayinitiative.com/advisories/ZDI-14-078/");
