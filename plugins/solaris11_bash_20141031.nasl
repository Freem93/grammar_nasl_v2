...
if (description)
{
  ...
  script_cvs_date("$Date: 2016/02/02 20:38:47 $");

  script_cve_id("CVE-2014-6271", "CVE-2014-6278", "CVE-2014-7169", "CVE-2014-7186", "CVE-2014-7187");
...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3243992c"
  );
  script_set_attribute(attribute:"solution", value:"Upgrade to Solaris 11.2.2.8.0.");
