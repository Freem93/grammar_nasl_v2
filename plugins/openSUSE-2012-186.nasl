...
if (description)
{
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://lists.opensuse.org/opensuse-updates/2012-03/msg00051.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.4", reference:"libpng12-0-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng12-0-debuginfo-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng12-compat-devel-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng12-debugsource-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng12-devel-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-14-1.4.4-17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-14-debuginfo-1.4.4-17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-compat-devel-1.4.4-17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-debugsource-1.4.4-17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-devel-1.4.4-17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng12-0-32bit-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng12-0-debuginfo-32bit-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng12-compat-devel-32bit-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng12-devel-32bit-1.2.48-13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng14-14-32bit-1.4.4-17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng14-14-debuginfo-32bit-1.4.4-17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng14-compat-devel-32bit-1.4.4-17.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng14-devel-32bit-1.4.4-17.1") ) flag++;
