...
if (description)
{
  ...
  script_cvs_date("$Date: 2016/05/24 13:28:18 $");

  script_cve_id("CVE-2015-2370");
#  script_bugtraq_id();
  script_osvdb_id(124321);
...
to log onto the system.");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS15-076");
