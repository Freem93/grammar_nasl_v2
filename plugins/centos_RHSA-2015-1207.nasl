...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-38.1.0-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-38.1.0-1.el6.centos")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-38.1.0-1.el7.centos")) flag++;
