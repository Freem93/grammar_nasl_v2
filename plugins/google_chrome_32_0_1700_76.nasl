...
vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Google Chrome 32.0.1700.76 or later.");
...
google_chrome_check_version(installs:installs, fix:'32.0.1700.76', severity:SECURITY_WARNING, xss:TRUE);
