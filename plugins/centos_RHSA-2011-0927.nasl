...
take effect."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2011-July/017646.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b5c12b8"
  );
  # http://lists.centos.org/pipermail/centos-announce/2011-July/017647.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?068fa427"
  );
  script_set_attribute(
    attribute:"solution", 
