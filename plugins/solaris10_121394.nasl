...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"121394-03", obsoleted_by:"142900-02 140562-02 142909-17 ", package:"SUNWckr", version:"11.10.0,REV=2005.01.21.15.53");
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"121394-03", obsoleted_by:"142900-02 140562-02 142909-17 ", package:"SUNWhea", version:"11.10.0,REV=2005.01.21.15.53");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
