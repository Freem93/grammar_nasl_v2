...
if (description)
{
  ...
  script_osvdb_id(119757, 133715, 135095, 135096, 135121, 135149, 135151, 135152, 135153);

  script_name(english:"SUSE SLED12 Security Update : openssl (SUSE-SU-2016:0641-1) (DROWN)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160641-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8eeabbb2"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
