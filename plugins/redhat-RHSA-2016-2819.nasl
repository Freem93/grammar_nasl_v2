...
(CVE-2016-8706)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2016-8706.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2016-2819.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"memcached-debuginfo-1.4.15-10.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"memcached-debuginfo-1.4.15-10.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"memcached-devel-1.4.15-10.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"memcached-devel-1.4.15-10.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"memcached-devel-1.4.15-10.el7_3.1")) flag++;
