...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : pcs on SL6.x i386/srpm/x86_64");
...
restarted automatically."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1505&L=scientific-linux-errata&T=0&P=1737
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?39fa5871"
  );
  script_set_attribute(
    attribute:"solution", 
