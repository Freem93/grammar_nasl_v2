...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 148112-02");
  script_summary(english:"Check for patch 148112-02");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 148112-02"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"148112-02", obsoleted_by:"", package:"SUNWcsu", version:"11.10.0,REV=2005.01.21.15.53") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"148112-02", obsoleted_by:"", package:"SUNWcakr", version:"11.10.0,REV=2005.08.25.02.12") < 0) flag++;
