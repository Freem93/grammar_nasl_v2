...
contain a backported patches to resolve these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2008-February/014700.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?99db7f9a"
  );
  # http://lists.centos.org/pipermail/centos-announce/2008-February/014701.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0097bed7"
  );
