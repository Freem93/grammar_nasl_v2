...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 124848-04");
  script_summary(english:"Check for patch 124848-04");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 124848-04"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"124848-04", obsoleted_by:"", package:"SUNWuttsc", version:"1.1_15") < 0) flag++;
