...
for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2013-0695.html"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL5", sp:"6", cpu:"s390x", reference:"kernel-debug-debuginfo-2.6.18-238.49.1.el5")) flag++;
  ...
  if (rpm_check(release:"RHEL5", sp:"6", cpu:"s390x", reference:"kernel-debuginfo-2.6.18-238.49.1.el5")) flag++;
  ...
  if (rpm_check(release:"RHEL5", sp:"6", cpu:"s390x", reference:"kernel-debuginfo-common-2.6.18-238.49.1.el5")) flag++;
  ...
  if (rpm_check(release:"RHEL5", sp:"6", cpu:"s390x", reference:"kernel-kdump-debuginfo-2.6.18-238.49.1.el5")) flag++;
