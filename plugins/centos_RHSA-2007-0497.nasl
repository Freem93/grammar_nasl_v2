...
Preview."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-June/013937.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a53bef05"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-June/013938.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b0ac3ab"
  );
  script_set_attribute(
    attribute:"solution", 
