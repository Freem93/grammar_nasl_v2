...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python on SL6.x, SL7.x i386/x86_64 (httpoxy)");
...
"Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1608&L=scientific-linux-errata&F=&S=&P=6431
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1ff43cdf"
  );
