...
if (description)
{
  ...
  script_osvdb_id(94335, 94336, 94337, 94339, 94340, 94341, 94347, 94348, 94350, 94352, 94355, 94356, 94357, 94358, 94362, 94363, 94364, 94365, 94366, 94367, 94368, 94369, 94370, 94372, 94374);
...
OpenJDK Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4f4a948f"
  );
  # http://lists.centos.org/pipermail/centos-announce/2013-July/019835.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ce09383"
  );
  script_set_attribute(
    attribute:"solution", 
