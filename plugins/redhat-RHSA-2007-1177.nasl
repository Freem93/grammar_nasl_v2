...
if (description)
{
  ...
  script_cvs_date("$Date: 2016/12/29 15:45:05 $");
...
Red Hat would like to thank Tim Baum for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2007-6285.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2007-1177.html"
  );
  script_set_attribute(
    attribute:"solution", 
