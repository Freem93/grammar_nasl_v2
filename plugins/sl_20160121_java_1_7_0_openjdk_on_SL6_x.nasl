...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.7.0-openjdk on SL6.x i386/x86_64 (SLOTH)");
...
to take effect."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1601&L=scientific-linux-errata&F=&S=&P=9719
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?26d921bf"
  );
