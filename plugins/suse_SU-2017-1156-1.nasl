...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1023990"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2017-6369.html"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20171156-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e373a90"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
