...
if (description)
{
  ...
  script_name(english:"Slackware current : zlib upgrade fixes vulnerability");
  ...
  script_set_attribute(
    ...
    value:
"New zlib packages are available to fix a security problem which may
impact programs that link with zlib."
  );
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2002&m=slackware-security.261728
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?047bab73"
  );
...
flag = 0;
if (slackware_check(osver:"current", pkgname:"zlib", pkgver:"1.1.4", pkgarch:"i386", pkgnum:"1")) flag++;
