...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1004237"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-8602.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162723-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?883ed667"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
