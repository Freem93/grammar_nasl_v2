...
if (description)
{
  ...
  script_cvs_date("$Date: 2015/09/17 21:08:50 $");

  script_cve_id("CVE-2015-2535");
  script_bugtraq_id(76554);
  script_osvdb_id(127185);
...
resulting in the Active Directory service becoming non-responsive.");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS15-096");
