...
if (description)
{
 ...
 script_osvdb_id(46066);
 script_xref(name:"IAVA", value:"2008-A-0041");
...
this flaw to crash the remote Active Directory server.");
 script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/ms08-035");
