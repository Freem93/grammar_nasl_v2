...
security context of the affected site.");
  script_set_attribute(attribute:"see_also", value:"http://secpod.org/advisories/SecPod_LogAnalyzer_XSS_Vuln.txt");
  # http://loganalyzer.adiscon.com/downloads/loganalyzer-3-4-4-v3-stable
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ee30cc11");
  # http://loganalyzer.adiscon.com/news/loganalyzer-v3-5-5-v3-beta-released
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8effc594");
  script_set_attribute(attribute:"solution", value:"Upgrade to version 3.4.4 / 3.5.5 or later.");
