...
if (description)
{
  ...
  script_summary(english:"Check for patch 126546-06");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Oracle Security Patch number 126546-06");
