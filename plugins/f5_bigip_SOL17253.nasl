...
# extracted from F5 Networks BIG-IP Solution SOL17253.
#
...
if (description)
{
  ...
  script_osvdb_id(127546);

  script_name(english:"F5 Networks BIG-IP : BIG-IP Configuration utility vulnerability (SOL17253)");
  ...
  script_set_attribute(
    ...
    value:
"An authenticated user issue a request to the BIG-IP configuration
utility that contains a path traversal."
  );
  # http://support.f5.com/kb/en-us/solutions/public/17000/200/sol17253.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2ea2e552"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
