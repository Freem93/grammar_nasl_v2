...
Thanks to Marcus Meissner for providing a patch for this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2002-0658.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.engelschall.com/sw/mm/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2002-154.html"
  );
  script_set_attribute(
    attribute:"solution", 
