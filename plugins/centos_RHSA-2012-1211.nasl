...
changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b3f598e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2012-August/018835.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b5c696a5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-10.0.7-1.el5.centos")) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-10.0.7-1.el6.centos")) flag++;
