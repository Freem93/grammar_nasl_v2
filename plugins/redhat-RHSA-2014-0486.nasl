...
if (description)
{
  ...
  script_osvdb_id(99711, 101309, 102808, 105866, 105867, 105869, 105873, 105874, 105875, 105876, 105877, 105878, 105879, 105880, 105881, 105882, 105883, 105884, 105885, 105886, 105887, 105889, 105890, 105895, 105897, 105898, 105899);
...
instances of IBM Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2014-0486.html"
  );
