...
if (description)
{
  ...
  script_osvdb_id(78704);
  script_xref(name:"RHSA", value:"2012:0037");
  script_xref(name:"IAVB", value:"2012-B-0011");

  script_name(english:"RHEL 4 / 5 / 6 : mod_cluster-native (RHSA-2012:0037)");
...
Solution section for installation instructions."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2011-4608.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://docs.redhat.com/docs/en-US/index.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2012-0037.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", cpu:"i386", reference:"mod_cluster-native-1.0.10-4.GA_CP02.ep5.el4")) flag++;
  if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"mod_cluster-native-1.0.10-4.GA_CP02.ep5.el4")) flag++;
