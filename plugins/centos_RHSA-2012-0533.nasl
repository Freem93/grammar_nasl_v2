...
this update, the smb service will be restarted automatically."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2012-April/018606.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?343b6c1a"
  );
  # http://lists.centos.org/pipermail/centos-announce/2012-April/018608.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a8fcc816"
  );
  script_set_attribute(
    attribute:"solution", 
