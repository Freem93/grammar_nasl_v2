...
Security Fix(es) :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1704&L=scientific-linux-errata&F=&S=&P=17959
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0ec6585d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-52.1.0-2.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-52.1.0-2.el6_9")) flag++;
