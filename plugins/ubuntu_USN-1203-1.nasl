...
# extracted from Ubuntu Security Notice USN-1203-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(48333, 48804, 48929, 49152);
  script_xref(name:"USN", value:"1203-1");

  script_name(english:"Ubuntu 10.04 LTS : linux-mvl-dove vulnerabilities (USN-1203-1)");
...
these flaws to execute arbitrary code as root. (CVE-2011-4914)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected linux-image-2.6.32-218-dove package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-218-dove", pkgver:"2.6.32-218.36")) flag++;
