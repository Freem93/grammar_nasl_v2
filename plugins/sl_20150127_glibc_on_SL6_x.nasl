...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : glibc on SL6.x, SL7.x i386/x86_64 (GHOST)");
...
the user running the application. (CVE-2015-0235)"
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1501&L=scientific-linux-errata&T=0&P=2821
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1dd21fbe"
  );
