...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/1022805"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-2399.html"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170610-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?50ac021e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
