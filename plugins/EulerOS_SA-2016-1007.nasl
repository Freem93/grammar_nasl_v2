...
vulnerability :
  ...
  - It was found that the fix for CVE-2015-1805 incorrectly
    ...
    memory to user space. (CVE-2016-0774)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # http://developer.huawei.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1007
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e33a4fff");
