...
which contain backported fixes to correct these issues."
  ...
  # http://lists.centos.org/pipermail/centos-announce/2007-September/014176.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3593bd4e"
  );
  # http://lists.centos.org/pipermail/centos-announce/2007-September/014177.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f8e3319f"
  );
  script_set_attribute(
    attribute:"see_also",
