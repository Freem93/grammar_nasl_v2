...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 119467-17");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"119467-17", obsoleted_by:"", package:"SUNWamutl", version:"6.2,REV=04.04.23.19.50") < 0) flag++;
