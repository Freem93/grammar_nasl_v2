...
only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"solution", value:"Update to Apache Tomcat version 7.0.52 or later.");
...
tomcat_check_version(fixed:"7.0.51", min:"7.0.0", severity:SECURITY_WARNING, granularity_regex:"^7(\.0)?$");
