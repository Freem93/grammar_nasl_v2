...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ccid on SL6.x i386/x86_64");
...
This update also fixes the following bug :
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1303&L=scientific-linux-errata&T=0&P=1296
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f31cc1a"
  );
  script_set_attribute(
    attribute:"solution", 
