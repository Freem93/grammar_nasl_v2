...
The following non-security bugs were fixed :
  ...
  - bsc#922710: Prevent rsyncd from spamming the log when
    trying to register SLP.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/898513"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/922710"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7a8858eb"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
