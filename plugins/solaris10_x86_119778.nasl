...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 119778-19");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"119778-19", obsoleted_by:"121582-12 ", package:"SUNWcomic", version:"1.0,REV=2003.10.29") < 0) flag++;
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"119778-19", obsoleted_by:"121582-12 ", package:"SUNWcomis", version:"1.0,REV=2003.10.29") < 0) flag++;
