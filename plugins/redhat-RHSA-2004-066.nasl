...
bootloader) is also included."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2004-0077.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www10.software.ibm.com/developerworks/opensource/linux390/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2004-066.html"
  );
