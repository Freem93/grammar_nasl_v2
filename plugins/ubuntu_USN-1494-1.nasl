...
# Notice USN-1494-1.  It is released under the Nessus Script 
# Licence.
#
...
if (description)
{
 ...
 script_cve_id("CVE-2012-2375");
  ...
  script_name(english:"USN-1494-1 : linux-ti-omap4 vulnerability");
...
(attacker) could cause a denial of service (OOPS).");
  script_set_attribute(attribute:"see_also", value:"http://www.ubuntu.com/usn/usn-1494-1/");
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-1415-omap4", pkgver:"3.2.0-1415.20")) flag++;
