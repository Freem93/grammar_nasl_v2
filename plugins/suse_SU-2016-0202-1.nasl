...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/949160"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/960319"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-7555.html"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160202-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?afd8283a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
