...
Active Directory servers. (BZ#618290)"
  ...
  # http://lists.centos.org/pipermail/centos-announce/2010-October/017081.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97931773"
  );
  # http://lists.centos.org/pipermail/centos-announce/2010-October/017082.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fe1fb7db"
  );
  script_set_attribute(
    attribute:"solution", 
