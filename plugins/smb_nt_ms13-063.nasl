...
if (description)
{
  ...
  script_bugtraq_id(58566, 61682, 61683, 61684);
  script_osvdb_id(91195, 96178, 96179, 96180);
...
multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.zerodayinitiative.com/advisories/ZDI-13-192/");
  script_set_attribute(attribute:"see_also", value:"http://www.securityfocus.com/archive/1/528339/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/library/security/MS13-063");
  script_set_attribute(
    attribute:"solution",
    value:
