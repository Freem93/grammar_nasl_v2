...
privileges to root. (CVE-2016-9566)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-0259.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected nagios, nagios-common and / or nagios-devel
packages."
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"nagios-devel-3.5.1-9.el6")) flag++;
