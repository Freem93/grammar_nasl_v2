...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xfsprogs on SL7.x x86_64");
...
format change (for metadata checksumming) which is present upstream."
  ...
  # http://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=9537
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b0c39b32"
  );
