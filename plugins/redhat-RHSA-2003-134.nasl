...
contain fixes for a number of other bugs."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2003-0124.html"
  );
  # http://marc.theaimsgroup.com/?l=bugtraq&m=104740927915154
  script_set_attribute(
    attribute:"see_also",
    value:"http://marc.info/?l=bugtraq&m=104740927915154"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2003-134.html"
  );
