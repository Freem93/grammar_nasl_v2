...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 136860-02");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"136860-02", obsoleted_by:"", package:"VRTSnetbp", version:"6.0,REV=2006.11.09.18.12") < 0) flag++;
