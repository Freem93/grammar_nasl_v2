...
flag = 0;
if (rpm_check(release:"EL5", reference:"firefox-31.3.0-4.0.1.el5_11")) flag++;

if (rpm_check(release:"EL6", reference:"firefox-31.3.0-3.0.1.el6_6")) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-31.3.0-3.0.1.el7_0")) flag++;
