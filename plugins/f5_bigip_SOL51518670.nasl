...
# extracted from F5 Networks BIG-IP Solution K51518670.
#
...
if (description)
{
  ...
  script_osvdb_id(120282);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K51518670)");
...
Advertisement (RA) message. (CVE-2015-2922)"
  );
  script_set_attribute(
    attribute:"see_also",
